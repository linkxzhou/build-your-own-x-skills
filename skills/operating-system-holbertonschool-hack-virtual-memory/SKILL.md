---
name: operating-system-holbertonschool-hack-virtual-memory
description: |
  Trigger when the user wants to learn, implement, debug, or extend "黑进虚拟内存" or a 操作系统 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://blog.holbertonschool.com/hack-the-virtual-memory-c-strings-proc/
