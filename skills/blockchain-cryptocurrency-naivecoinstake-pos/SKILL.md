---
name: blockchain-cryptocurrency-naivecoinstake-pos
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using TypeScript. Use when they mention "build your own blockchain-cryptocurrency", "NaivecoinStake：基于 PoS 共识构建加密货币的教程", the source URL, or ask for a Claude Code guided implementation plan.
...
# NaivecoinStake：基于 PoS 共识构建加密货币的教程
...
- **Original resource**: https://naivecoinstake.learn.uno/
...
2. Detect the target language/toolchain. Default to **TypeScript** when the user does not specify another stack.
