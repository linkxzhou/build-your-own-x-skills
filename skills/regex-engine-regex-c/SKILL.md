---
name: regex-engine-regex-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using C. Use when they mention "build your own regex-engine", "正则匹配可以既简单又快速", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 正则表达式引擎
- **Language / stack**: C
- **Original resource**: https://swtch.com/~rsc/regexp/regexp1.html
