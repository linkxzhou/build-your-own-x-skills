---
name: emulator-virtual-machine-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using C. Use when they mention "build your own emulator-virtual-machine", "用 C 写虚拟机", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: C
- **Original resource**: http://web.archive.org/web/20200121100942/https://blog.felixangell.com/virtual-machine-in-c/
