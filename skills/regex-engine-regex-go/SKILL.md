---
name: regex-engine-regex-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using Go. Use when they mention "build your own regex-engine", "如何从零构建正则引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 正则表达式引擎
- **Language / stack**: Go
- **Original resource**: https://rhaeguard.github.io/posts/regex
