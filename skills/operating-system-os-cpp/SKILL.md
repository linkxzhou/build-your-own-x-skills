---
name: operating-system-os-cpp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using C++. Use when they mention "build your own operating-system", "写你自己的操作系统", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: C++
- **Original resource**: https://www.youtube.com/playlist?list=PLHh55M_Kq4OApWScZyPl5HhgsTJS9MZ6M
