---
name: emulator-virtual-machine-chip8-lisp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using Common Lisp. Use when they mention "build your own emulator-virtual-machine", "用 Common Lisp 实现 CHIP-8", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: Common Lisp
- **Original resource**: http://stevelosh.com/blog/2016/12/chip8-cpu/
...
2. Detect the target language/toolchain. Default to **Common Lisp** when the user does not specify another stack.
