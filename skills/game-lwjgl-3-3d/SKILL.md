---
name: game-lwjgl-3-3d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Java. Use when they mention "build your own game", "LWJGL 3 的 3D 游戏开发", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Java
- **Original resource**: https://lwjglgamedev.gitbooks.io/3d-game-development-with-lwjgl/content/
