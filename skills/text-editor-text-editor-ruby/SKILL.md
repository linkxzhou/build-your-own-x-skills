---
name: text-editor-text-editor-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 文本编辑器 using Ruby. Use when they mention "build your own text-editor", "用 Rails 构建协作式文本编辑器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 文本编辑器
- **Language / stack**: Ruby
- **Original resource**: https://blog.aha.io/text-editor/
