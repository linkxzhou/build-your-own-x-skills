---
name: game-handmade-hero
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C. Use when they mention "build your own game", "Handmade Hero", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C
- **Original resource**: https://handmadehero.org/
