---
name: programming-language-scheme-haskell
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Haskell. Use when they mention "build your own programming-language", "Write You A Scheme", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.wespiser.com/writings/wyas/home.html
