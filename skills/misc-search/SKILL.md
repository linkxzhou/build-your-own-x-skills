...
name: misc-search
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using PHP. Use when they mention "build your own misc", "用 PHP 编写 Web 搜索引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: PHP
- **Original resource**: https://boyter.org/2013/01/code-for-a-search-engine-in-php-part-1/
