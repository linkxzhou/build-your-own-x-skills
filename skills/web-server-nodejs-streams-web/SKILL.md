---
name: web-server-nodejs-streams-web
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Node.js. Use when they mention "build your own web-server", "用 NodeJS Streams 从零写 Web 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.codementor.io/@ziad-saab/let-s-code-a-web-server-from-scratch-with-nodejs-streams-h4uc9utji
