...
name: misc-cache
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建你自己的缓存" or a 未分类 build-your-own project using Kotlin. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://github.com/kezhenxu94/cache-lite

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `Kotlin` unless the user chooses another stack.
