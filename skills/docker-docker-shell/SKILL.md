---
name: docker-docker-shell
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Docker using Shell. Use when they mention "build your own docker", "用大约 100 行 bash 实现 Docker", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/p8952/bocker
...
2. Detect the target language/toolchain. Default to **Shell** when the user does not specify another stack.
