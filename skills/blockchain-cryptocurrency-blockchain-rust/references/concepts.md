# Concepts checklist: 用 Rust 与 Substrate 构建区块链（分步指南）
...
- Category: 区块链 / 加密货币
- Language / stack: Rust
- Source: https://hackernoon.com/building-a-blockchain-in-rust-and-substrate-a-step-by-step-guide-for-developers-kc223ybp
