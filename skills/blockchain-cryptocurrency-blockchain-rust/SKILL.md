---
name: blockchain-cryptocurrency-blockchain-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Rust. Use when they mention "build your own blockchain-cryptocurrency", "用 Rust 与 Substrate 构建区块链（分步指南）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Rust
- **Original resource**: https://hackernoon.com/building-a-blockchain-in-rust-and-substrate-a-step-by-step-guide-for-developers-kc223ybp
...
2. Detect the target language/toolchain. Default to **Rust** when the user does not specify another stack.
