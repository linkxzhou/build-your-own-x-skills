---
name: programming-language-youtube
description: |
  Trigger when the user wants to learn, implement, debug, or extend "制作你自己的简单解释型编程语言" or a 编程语言 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://www.youtube.com/watch?v=dj9CBS3ikGA&list=PLZQftyCk7_SdoVexSmwy_tBgs7P0b97yD&index=1
