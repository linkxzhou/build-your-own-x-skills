---
name: neural-network-neural-network-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using JavaScript. Use when they mention "build your own neural-network", "面向 JavaScript 语言学家的神经网络从零开始（第 1 部分：感知机）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://hackernoon.com/neural-networks-from-scratch-for-javascript-linguists-part1-the-perceptron-632a4d1fbad2
