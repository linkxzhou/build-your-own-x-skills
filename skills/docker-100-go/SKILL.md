...
name: docker-100-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Docker using Go. Use when they mention "build your own docker", "用不到 100 行 Go 构建自己的容器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Docker
- **Language / stack**: Go
- **Original resource**: https://www.infoq.com/articles/build-a-container-golang
