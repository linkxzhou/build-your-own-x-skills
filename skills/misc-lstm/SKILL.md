...
name: misc-lstm
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Python. Use when they mention "build your own misc", "用 LSTM 预测股市", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.datacamp.com/community/tutorials/lstm-python-stock-market
