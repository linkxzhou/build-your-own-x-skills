---
name: web-server-javascript-web
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Node.js. Use when they mention "build your own web-server", "用 JavaScript 从零构建你自己的 Web 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://build-your-own.org/webserver/
