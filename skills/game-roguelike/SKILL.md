...
name: game-roguelike
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using JavaScript. Use when they mention "build your own game", "如何制作你的第一个 Roguelike", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://gamedevelopment.tutsplus.com/tutorials/how-to-make-your-first-roguelike--gamedev-13677
