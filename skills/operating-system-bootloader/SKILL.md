---
name: operating-system-bootloader
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using Assembly. Use when they mention "build your own operating-system", "编写一个微型 x86 引导程序（Bootloader）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: Assembly
- **Original resource**: http://joebergeron.io/posts/post_two.html
...
2. Detect the target language/toolchain. Default to **Assembly** when the user does not specify another stack.
