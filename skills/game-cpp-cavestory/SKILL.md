---
name: game-cpp-cavestory
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C++. Use when they mention "build your own game", "用 C++ 重制 Cavestory", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C++
- **Original resource**: https://www.youtube.com/watch?v=ETvApbD5xRo&list=PLNOBk_id22bw6LXhrGfhVwqQIa-M2MsLa
