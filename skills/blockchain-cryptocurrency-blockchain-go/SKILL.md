---
name: blockchain-cryptocurrency-blockchain-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Go. Use when they mention "build your own blockchain-cryptocurrency", "用 Go 构建区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Go
- **Original resource**: https://jeiwan.net/posts/building-blockchain-in-go-part-1/
