---
name: git-git-wyag-thb-lt
description: |
  Trigger when the user wants to learn, implement, debug, or extend "给自己写一个 Git！" or a Git build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://wyag.thb.lt/
