---
name: neural-network-neural-network-f
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using F#. Use when they mention "build your own neural-network", "用 F# 构建神经网络", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 神经网络
- **Language / stack**: F#
- **Original resource**: https://towardsdatascience.com/building-neural-networks-in-f-part-1-a2832ae972e6
...
2. Detect the target language/toolchain. Default to **F#** when the user does not specify another stack.
