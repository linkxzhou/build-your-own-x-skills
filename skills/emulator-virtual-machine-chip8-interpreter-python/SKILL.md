---
name: emulator-virtual-machine-chip8-interpreter-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using Python. Use when they mention "build your own emulator-virtual-machine", "模拟器基础：编写你自己的 Chip-8 模拟器/解释器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://omokute.blogspot.com.br/2012/06/emulation-basics-write-your-own-chip-8.html
