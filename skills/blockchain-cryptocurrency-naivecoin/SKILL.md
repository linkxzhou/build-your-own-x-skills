---
name: blockchain-cryptocurrency-naivecoin
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using TypeScript. Use when they mention "build your own blockchain-cryptocurrency", "Naivecoin：构建加密货币的教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://lhartikk.github.io/
