---
name: programming-language-interpreter-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using JavaScript. Use when they mention "build your own programming-language", "超小解释器（The Super Tiny Interpreter）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/keyanzhang/the-super-tiny-interpreter
