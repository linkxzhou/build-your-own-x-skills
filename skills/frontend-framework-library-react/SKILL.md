---
name: frontend-framework-library-react
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 前端框架 / 库 using JavaScript. Use when they mention "build your own frontend-framework-library", "从零构建你自己的 React（DIY 指南）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/hexacta/didact
