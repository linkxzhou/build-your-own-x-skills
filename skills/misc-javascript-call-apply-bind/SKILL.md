---
name: misc-javascript-call-apply-bind
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using JavaScript. Use when they mention "build your own misc", "自己实现 JavaScript 的 call() / apply() / bind()", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://blog.usejournal.com/implement-your-own-call-apply-and-bind-method-in-javascript-42cc85dba1b
