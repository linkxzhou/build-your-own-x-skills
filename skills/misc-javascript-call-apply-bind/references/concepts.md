# Concepts checklist: 自己实现 JavaScript 的 call() / apply() / bind()
...
- Source: https://blog.usejournal.com/implement-your-own-call-apply-and-bind-method-in-javascript-42cc85dba1b
