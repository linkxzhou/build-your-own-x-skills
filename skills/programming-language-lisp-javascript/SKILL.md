---
name: programming-language-lisp-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using JavaScript. Use when they mention "build your own programming-language", "让我们写一个 Lisp", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://idiocy.org/lets-go-write-a-lisp/part-1.html
