---
name: misc-nbaksalyar-2015-07-10
description: |
  Trigger when the user wants to learn, implement, debug, or extend "从零编写可扩展聊天服务" or a 未分类 build-your-own project using Rust. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Rust
- **Original resource**: https://nbaksalyar.github.io/2015/07/10/writing-chat-in-rust.html
