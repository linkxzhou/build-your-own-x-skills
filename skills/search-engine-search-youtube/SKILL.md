---
name: search-engine-search-youtube
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建基于 Python 的搜索引擎" or a 搜索引擎 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://www.youtube.com/watch?v=cY7pE7vX6MU
