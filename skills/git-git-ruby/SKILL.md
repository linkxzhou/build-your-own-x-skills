...
name: git-git-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Git using Ruby. Use when they mention "build your own git", "用 Ruby 重建 Git", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Git
- **Language / stack**: Ruby
- **Original resource**: https://robots.thoughtbot.com/rebuilding-git-in-ruby
