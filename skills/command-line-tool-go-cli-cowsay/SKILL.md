---
name: command-line-tool-go-cli-cowsay
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Go. Use when they mention "build your own command-line-tool", "用 Go 构建 CLI 命令：cowsay", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Go
- **Original resource**: https://flaviocopes.com/go-tutorial-cowsay/
