---
name: template-engine-template-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模板引擎 using Ruby. Use when they mention "build your own template-engine", "如何在不到 30 行代码里写一个模板引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 模板引擎
- **Language / stack**: Ruby
- **Original resource**: http://bits.citrusbyte.com/how-to-write-a-template-library/
