---
name: web-server-lets-build-express
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Node.js. Use when they mention "build your own web-server", "lets-build-express", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/antoaravinth/lets-build-express
