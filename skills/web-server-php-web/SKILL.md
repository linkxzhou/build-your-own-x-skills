---
name: web-server-php-web
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using PHP. Use when they mention "build your own web-server", "用纯 PHP 编写 Web 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Web 服务器
- **Language / stack**: PHP
- **Original resource**: http://station.clancats.com/writing-a-webserver-in-pure-php/
...
2. Detect the target language/toolchain. Default to **PHP** when the user does not specify another stack.
