...
name: misc-100-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Go. Use when they mention "build your own misc", "100 行 Go 构建简单终端模拟器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: Go
- **Original resource**: https://ishuah.com/2021/03/10/build-a-terminal-emulator-in-100-lines-of-go/
