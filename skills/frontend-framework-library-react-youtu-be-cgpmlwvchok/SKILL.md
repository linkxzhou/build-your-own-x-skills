---
name: frontend-framework-library-react-youtu-be-cgpmlwvchok
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建一个自定义 React Renderer" or a 前端框架 / 库 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 构建一个自定义 React Renderer
...
- **Original resource**: https://youtu.be/CGpMlWVcHok
