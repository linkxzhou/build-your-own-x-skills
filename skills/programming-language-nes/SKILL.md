---
name: programming-language-nes
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Assembly. Use when they mention "build your own programming-language", "Jonesforth", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/nornagon/jonesforth/blob/master/jonesforth.S
