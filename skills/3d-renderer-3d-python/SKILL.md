---
name: 3d-renderer-3d-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using Python. Use when they mention "build your own 3d-renderer", "一个 3D 建模器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://aosabook.org/en/500L/a-3d-modeller.html
