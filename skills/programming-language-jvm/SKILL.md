---
name: programming-language-jvm
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Java. Use when they mention "build your own programming-language", "创建 JVM 语言", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: Java
- **Original resource**: http://jakubdziworski.github.io/categories.html#Enkel-ref
