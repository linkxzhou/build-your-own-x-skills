---
name: emulator-virtual-machine-master-system
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using C++. Use when they mention "build your own emulator-virtual-machine", "模拟器教程（Master System 模拟器）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: C++
- **Original resource**: http://www.codeslinger.co.uk/pages/projects/mastersystem/memory.html
