...
name: shell-shell-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Shell using C. Use when they mention "build your own shell", "让我们构建一个 Shell！", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Shell
- **Language / stack**: C
- **Original resource**: https://github.com/kamalmarhubi/shell-workshop
