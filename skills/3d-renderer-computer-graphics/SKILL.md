---
name: 3d-renderer-computer-graphics
description: |
  Trigger when the user wants to learn, implement, debug, or extend "从零开始的计算机图形学" or a 3D 渲染器 build-your-own project using JavaScript / Pseudocode. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 3D 渲染器
- **Language / stack**: JavaScript / Pseudocode
- **Original resource**: http://www.gabrielgambetta.com/computer-graphics-from-scratch/introduction.html

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `JavaScript / Pseudocode` unless the user chooses another stack.
