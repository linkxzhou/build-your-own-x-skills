---
name: neural-network-neural-network-victorzhou-intro-neural-networks
description: |
  Trigger when the user wants to learn, implement, debug, or extend "从零实现神经网络" or a 神经网络 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://victorzhou.com/blog/intro-to-neural-networks/
