---
name: database-redis-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Go. Use when they mention "build your own database", "从零构建你自己的 Redis", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 数据库
- **Language / stack**: Go
- **Original resource**: https://www.build-redis-from-scratch.dev/
