---
name: neural-network-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using Go. Use when they mention "build your own neural-network", "用 Go 构建多层感知机", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 神经网络
- **Language / stack**: Go
- **Original resource**: https://made2591.github.io/posts/neuralnetwork
