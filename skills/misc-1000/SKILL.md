...
name: misc-1000
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C. Use when they mention "build your own misc", "如何用不到 1000 行代码写一个视频播放器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C
- **Original resource**: http://dranger.com/ffmpeg/ffmpeg.html
