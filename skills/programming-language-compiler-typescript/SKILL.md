---
name: programming-language-compiler-typescript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using TypeScript. Use when they mention "build your own programming-language", "构建你自己的 WebAssembly 编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://blog.scottlogic.com/2019/05/17/webassembly-compiler.html
