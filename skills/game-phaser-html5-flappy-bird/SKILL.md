---
name: game-phaser-html5-flappy-bird
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using JavaScript. Use when they mention "build your own game", "用 Phaser 在 HTML5 中做 Flappy Bird", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://www.lessmilk.com/tutorial/flappy-bird-phaser-1
