---
name: command-line-tool-go-cli-fortune
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Go. Use when they mention "build your own command-line-tool", "Go CLI 教程：fortune 克隆", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Go
- **Original resource**: https://flaviocopes.com/go-tutorial-fortune/
