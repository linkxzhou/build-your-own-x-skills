---
name: misc-php-php-mvc
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using General. Use when they mention "build your own misc", "**PHP**: _用 PHP 从零编写 MVC_", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: General
- **Original resource**: https://chaitya62.github.io/2018/04/29/Writing-your-own-MVC-from-Scratch-in-PHP.html
...
2. Detect the target language/toolchain. Default to **General** when the user does not specify another stack.
