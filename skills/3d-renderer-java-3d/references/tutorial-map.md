# Tutorial map: 如何用纯 Java 创建一个简单的 3D 渲染引擎

## Original resource

- URL: http://blog.rogach.org/2015/08/how-to-create-your-own-simple-3d-render.html
- Language / stack: Java
- Category: 3D 渲染器
...
- Keep the implementation idiomatic for Java.
