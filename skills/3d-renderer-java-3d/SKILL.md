---
name: 3d-renderer-java-3d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using Java. Use when they mention "build your own 3d-renderer", "如何用纯 Java 创建一个简单的 3D 渲染引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 3D 渲染器
- **Language / stack**: Java
- **Original resource**: http://blog.rogach.org/2015/08/how-to-create-your-own-simple-3d-render.html
