---
name: misc-promise-tdd
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using JavaScript. Use when they mention "build your own misc", "从零实现 Promise（TDD 风格）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.mauriciopoppe.com/notes/computer-science/computation/promises/
