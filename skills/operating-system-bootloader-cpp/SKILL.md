---
name: operating-system-bootloader-cpp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using C++. Use when they mention "build your own operating-system", "编写 Bootloader", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: C++
- **Original resource**: http://3zanders.co.uk/2017/10/13/writing-a-bootloader/
