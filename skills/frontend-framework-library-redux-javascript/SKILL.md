---
name: frontend-framework-library-redux-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 前端框架 / 库 using JavaScript. Use when they mention "build your own frontend-framework-library", "让我们写 Redux！", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.jamasoftware.com/blog/lets-write-redux/
