---
name: database-database-clojure
description: |
  Trigger when the user wants to learn, implement, debug, or extend "考古学启发的数据库" or a 数据库 build-your-own project using Clojure. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: http://aosabook.org/en/500L/an-archaeology-inspired-database.html
