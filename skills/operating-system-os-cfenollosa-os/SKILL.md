---
name: operating-system-os-cfenollosa-os
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何从零创建一个 OS" or a 操作系统 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://github.com/cfenollosa/os-tutorial
