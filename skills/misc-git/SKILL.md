...
name: misc-git
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Python. Use when they mention "build your own misc", "用 Python 构建你自己的 Git 插件", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://joshburns-xyz.vercel.app/posts/build-your-own-git-plugin
