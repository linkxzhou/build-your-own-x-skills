---
name: game-rpg-csharp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C#. Use when they mention "build your own game", "通过构建一个简单 RPG 学习 C#", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C#
- **Original resource**: http://scottlilly.com/learn-c-by-building-a-simple-rpg-index/
