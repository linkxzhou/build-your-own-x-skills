---
name: blockchain-cryptocurrency-kotlin
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Kotlin. Use when they mention "build your own blockchain-cryptocurrency", "用 Kotlin 实现加密货币", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Kotlin
- **Original resource**: https://medium.com/@vasilyf/lets-implement-a-cryptocurrency-in-kotlin-part-1-blockchain-8704069f8580
...
2. Detect the target language/toolchain. Default to **Kotlin** when the user does not specify another stack.
