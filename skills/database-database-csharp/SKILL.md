---
name: database-database-csharp
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建你自己的数据库" or a 数据库 build-your-own project using C#. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 数据库
- **Language / stack**: C#
- **Original resource**: https://www.codeproject.com/Articles/1029838/Build-Your-Own-Database
