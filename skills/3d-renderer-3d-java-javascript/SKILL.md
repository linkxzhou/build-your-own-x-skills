---
name: 3d-renderer-3d-java-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using Java / JavaScript. Use when they mention "build your own 3d-renderer", "构建你自己的 3D 渲染器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 3D 渲染器
- **Language / stack**: Java / JavaScript
- **Original resource**: https://avik-das.github.io/build-your-own-raytracer/
...
2. Detect the target language/toolchain. Default to **Java / JavaScript** when the user does not specify another stack.
