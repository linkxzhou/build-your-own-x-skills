---
name: visual-recognition-system-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 视觉识别系统 using Python. Use when they mention "build your own visual-recognition-system", "用 Python 机器学习开发车牌识别系统", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://medium.com/devcenter/developing-a-license-plate-recognition-system-with-machine-learning-in-python-787833569ccd
