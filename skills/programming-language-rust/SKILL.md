...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Rust. Use when they mention "build your own programming-language", "用 Rust 学习解析器组合子", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: Rust
- **Original resource**: https://bodil.lol/parser-combinators/
