---
name: programming-language-interpreter-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Python. Use when they mention "build your own programming-language", "用 Python 写的 Python 解释器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://aosabook.org/en/500L/a-python-interpreter-written-in-python.html
