...
name: misc-nand
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using (any). Use when they mention "build your own misc", "从 NAND 到俄罗斯方块：从第一性原理构建现代计算机", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: (any)
- **Original resource**: http://nand2tetris.org/
