---
name: programming-language-lisp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using (any). Use when they mention "build your own programming-language", "mal - Make a Lisp", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: (any)
- **Original resource**: https://github.com/kanaka/mal#mal---make-a-lisp
