...
name: game-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Ruby. Use when they mention "build your own game", "用 Ruby 开发游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Ruby
- **Original resource**: https://leanpub.com/developing-games-with-ruby/read
