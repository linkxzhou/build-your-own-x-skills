...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using Assembly. Use when they mention "build your own operating-system", "Baking Pi：操作系统开发", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://www.cl.cam.ac.uk/projects/raspberrypi/tutorials/os/index.html
