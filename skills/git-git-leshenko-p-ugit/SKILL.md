---
name: git-git-leshenko-p-ugit
description: |
  Trigger when the user wants to learn, implement, debug, or extend "ugit：通过自己构建 Git 来学习 Git 内部原理" or a Git build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# ugit：通过自己构建 Git 来学习 Git 内部原理
...
- **Original resource**: https://www.leshenko.net/p/ugit/
