---
name: misc-brennan-2016-11-14
description: |
  Trigger when the user wants to learn, implement, debug, or extend "编写一个系统调用" or a 未分类 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: C
- **Original resource**: https://brennan.io/2016/11/14/kernel-dev-ep3/
