---
name: neural-network-zero-to-hero-neural-network
description: |
  Trigger when the user wants to learn, implement, debug, or extend "神经网络：从零到英雄（Zero to Hero）" or a 神经网络 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 神经网络：从零到英雄（Zero to Hero）
...
- **Original resource**: https://www.youtube.com/playlist?list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ
