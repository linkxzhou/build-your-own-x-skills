---
name: programming-language-compiler-elixir
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Elixir. Use when they mention "build your own programming-language", "通过自己写一个编译器来破除迷思", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.youtube.com/watch?v=zMJYoYwOCd4
...
2. Detect the target language/toolchain. Default to **Elixir** when the user does not specify another stack.
