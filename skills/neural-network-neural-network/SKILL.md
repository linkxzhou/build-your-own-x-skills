---
name: neural-network-neural-network
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using C#. Use when they mention "build your own neural-network", "神经网络 OCR", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 神经网络
- **Language / stack**: C#
- **Original resource**: https://www.codeproject.com/Articles/11285/Neural-Network-OCR
