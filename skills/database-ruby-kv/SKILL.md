---
name: database-ruby-kv
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Ruby. Use when they mention "build your own database", "用 Ruby 构建快速、持久化的 KV 存储", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 数据库
- **Language / stack**: Ruby
- **Original resource**: https://dineshgowda.com/posts/build-your-own-persistent-kv-store/
