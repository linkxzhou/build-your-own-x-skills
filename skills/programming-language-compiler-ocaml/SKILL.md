---
name: programming-language-compiler-ocaml
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using OCaml. Use when they mention "build your own programming-language", "编写一个 C 编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: OCaml
- **Original resource**: https://norasandler.com/2017/11/29/Write-a-Compiler.html
...
2. Detect the target language/toolchain. Default to **OCaml** when the user does not specify another stack.
