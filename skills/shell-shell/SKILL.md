...
name: shell-shell
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Shell using C. Use when they mention "build your own shell", "教程：用 C 写一个 Shell", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Shell
- **Language / stack**: C
- **Original resource**: https://brennan.io/2015/01/16/write-a-shell-in-c/
