---
name: text-editor-text-editor-general
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 文本编辑器 using General. Use when they mention "build your own text-editor", "**Rust**: _Hecto：用 Rust 构建你自己的文本编辑器_", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.flenker.blog/hecto/
