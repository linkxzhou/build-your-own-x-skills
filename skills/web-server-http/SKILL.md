...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Python. Use when they mention "build your own web-server", "用 Python 从零构建基础 HTTP Server", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://joaoventura.net/blog/2017/python-webserver/
