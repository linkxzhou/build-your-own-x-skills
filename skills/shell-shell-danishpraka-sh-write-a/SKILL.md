---
name: shell-shell-danishpraka-sh-write-a
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用 C 写一个 Shell" or a Shell build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: Shell
- **Language / stack**: C
- **Original resource**: https://danishpraka.sh/posts/write-a-shell/
