...
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用 Linux 内核与树莓派学习 OS 开发" or a 操作系统 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 用 Linux 内核与树莓派学习 OS 开发
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://github.com/s-matyukevich/raspberry-pi-os
