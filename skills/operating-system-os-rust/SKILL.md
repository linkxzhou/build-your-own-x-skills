---
name: operating-system-os-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using Rust. Use when they mention "build your own operating-system", "用 Rust 写操作系统", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: Rust
- **Original resource**: https://os.phil-opp.com/
