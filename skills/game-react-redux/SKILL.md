---
name: game-react-redux
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using JavaScript. Use when they mention "build your own game", "用 React、Redux 与 SVG 开发游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://auth0.com/blog/developing-games-with-react-redux-and-svg-part-1/
