---
name: template-engine-template
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模板引擎 using JavaScript. Use when they mention "build your own template-engine", "20 行实现 JavaScript 模板引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://krasimirtsonev.com/blog/article/Javascript-template-engine-in-just-20-line
