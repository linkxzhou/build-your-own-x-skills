---
name: blockchain-cryptocurrency-blockchain-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using JavaScript. Use when they mention "build your own blockchain-cryptocurrency", "用 JavaScript 构建你自己的区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/nambrot/blockchain-in-js
