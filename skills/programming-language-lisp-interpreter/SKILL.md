---
name: programming-language-lisp-interpreter
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using JavaScript. Use when they mention "build your own programming-language", "小型 Lisp 解释器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://maryrosecook.com/blog/post/little-lisp-interpreter
