---
name: emulator-virtual-machine-chip8-interpreter
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using C++. Use when they mention "build your own emulator-virtual-machine", "如何写一个模拟器（CHIP-8 解释器）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: C++
- **Original resource**: http://www.multigesture.net/articles/how-to-write-an-emulator-chip-8-interpreter/
