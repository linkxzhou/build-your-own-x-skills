...
name: git-git-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Git using Python. Use when they mention "build your own git", "刚好够用的 Git 客户端：能创建仓库、提交并把自己推到 GitHub", the source URL, or ask for a Claude Code guided implementation plan.
...
# 刚好够用的 Git 客户端：能创建仓库、提交并把自己推到 GitHub
...
- **Original resource**: https://benhoyt.com/writings/pygit/
