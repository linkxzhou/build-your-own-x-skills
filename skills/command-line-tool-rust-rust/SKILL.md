---
name: command-line-tool-rust-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Rust. Use when they mention "build your own command-line-tool", "用 Rust 编写命令行工具", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Rust
- **Original resource**: https://mattgathu.dev/2017/08/29/writing-cli-app-rust.html
