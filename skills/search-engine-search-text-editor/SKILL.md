---
name: search-engine-search-text-editor
description: |
  Trigger when the user wants to learn, implement, debug, or extend "让文本搜索从反馈中学习" or a 搜索引擎 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://medium.com/filament-ai/making-text-search-learn-from-feedback-4fe210fd87b0
