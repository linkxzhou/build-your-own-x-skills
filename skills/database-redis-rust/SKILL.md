---
name: database-redis-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Rust. Use when they mention "build your own database", "构建你自己的 Redis 客户端与服务端", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 数据库
- **Language / stack**: Rust
- **Original resource**: https://tokio.rs/tokio/tutorial/setup
