---
name: database-redis-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Python. Use when they mention "build your own database", "用 Python 写一个迷你 Redis", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://charlesleifer.com/blog/building-a-simple-redis-server-with-python/
