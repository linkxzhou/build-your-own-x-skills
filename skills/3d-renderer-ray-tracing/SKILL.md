---
name: 3d-renderer-ray-tracing
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using C++. Use when they mention "build your own 3d-renderer", "光线追踪导论：一种创建 3D 图像的简单方法", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 3D 渲染器
- **Language / stack**: C++
- **Original resource**: https://www.scratchapixel.com/lessons/3d-basic-rendering/introduction-to-ray-tracing/how-does-it-work
