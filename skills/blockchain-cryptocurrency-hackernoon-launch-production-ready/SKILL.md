---
name: blockchain-cryptocurrency-hackernoon-launch-production-ready
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何发布一个可用于生产的加密货币" or a 区块链 / 加密货币 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://hackernoon.com/how-to-launch-your-own-production-ready-cryptocurrency-ab97cb773371
