---
name: programming-language-compiler-pascal
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Pascal. Use when they mention "build your own programming-language", "让我们构建一个编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: Pascal
- **Original resource**: https://compilers.iecc.com/crenshaw/
...
2. Detect the target language/toolchain. Default to **Pascal** when the user does not specify another stack.
