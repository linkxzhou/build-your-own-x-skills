...
name: misc-nodejs-40
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Node.js. Use when they mention "build your own misc", "用 Node.js 用 40 行写静态站点生成器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.webdevdrops.com/en/build-static-site-generator-nodejs-8969ebe34b22/
