...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using C. Use when they mention "build your own programming-language", "Jack Crenshaw《Let’s Build a Compiler》的 C/x86 版本", the source URL, or ask for a Claude Code guided implementation plan.
...
# Jack Crenshaw《Let’s Build a Compiler》的 C/x86 版本
...
- **Category**: 编程语言
- **Language / stack**: C
- **Original resource**: https://github.com/lotabout/Let-s-build-a-compiler
