---
name: web-server-python-flask-restful-web-api
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Python. Use when they mention "build your own web-server", "用 Python + Flask 实现 RESTful Web API", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://blog.luisrei.com/articles/flaskrest.html
