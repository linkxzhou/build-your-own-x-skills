---
name: text-editor-text-editor-cpp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 文本编辑器 using C++. Use when they mention "build your own text-editor", "设计一个简单文本编辑器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 文本编辑器
- **Language / stack**: C++
- **Original resource**: http://www.fltk.org/doc-1.1/editor.html
