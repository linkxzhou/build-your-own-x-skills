---
name: programming-language-crafting-interpreters
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Java. Use when they mention "build your own programming-language", "《Crafting Interpreters》：制作编程语言的手册", the source URL, or ask for a Claude Code guided implementation plan.
...
# 《Crafting Interpreters》：制作编程语言的手册
...
- **Category**: 编程语言
- **Language / stack**: Java
- **Original resource**: http://www.craftinginterpreters.com/
