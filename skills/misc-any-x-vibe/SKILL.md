---
name: misc-any-x-vibe
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using (any). Use when they mention "build your own misc", "**(any)**: _build-your-own-x-vibe-coding：面向“vibe coding”改编的 BYOX 风格教程_", the source URL, or ask for a Claude Code guided implementation plan.
...
# **(any)**: _build-your-own-x-vibe-coding：面向“vibe coding”改编的 BYOX 风格教程_
...
- **Category**: 未分类
- **Language / stack**: (any)
- **Original resource**: https://github.com/inFaaa/build-your-own-x-vibe-coding
...
2. Detect the target language/toolchain. Default to **(any)** when the user does not specify another stack.
