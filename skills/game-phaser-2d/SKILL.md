...
name: game-phaser-2d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using JavaScript. Use when they mention "build your own game", "用 Phaser 制作 2D 打砖块", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://developer.mozilla.org/en-US/docs/Games/Tutorials/2D_breakout_game_Phaser
