...
name: bot-bot-r
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 机器人（Bot） using R. Use when they mention "build your own bot", "用 R 构建一个加密货币交易机器人", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 机器人（Bot）
- **Language / stack**: R
- **Original resource**: https://towardsdatascience.com/build-a-cryptocurrency-trading-bot-with-r-1445c429e1b1
...
2. Detect the target language/toolchain. Default to **R** when the user does not specify another stack.
