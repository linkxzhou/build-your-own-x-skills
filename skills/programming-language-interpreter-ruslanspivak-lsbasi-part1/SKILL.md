---
name: programming-language-interpreter-ruslanspivak-lsbasi-part1
description: |
  Trigger when the user wants to learn, implement, debug, or extend "让我们构建一个简单解释器" or a 编程语言 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://ruslanspivak.com/lsbasi-part1/
