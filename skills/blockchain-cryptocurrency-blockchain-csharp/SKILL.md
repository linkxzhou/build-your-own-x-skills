---
name: blockchain-cryptocurrency-blockchain-csharp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using C#. Use when they mention "build your own blockchain-cryptocurrency", "用 C# 编程实现区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: C#
- **Original resource**: https://programmingblockchain.gitbooks.io/programmingblockchain/
