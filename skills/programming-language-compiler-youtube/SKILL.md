---
name: programming-language-compiler-youtube
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何创建一个编译器" or a 编程语言 build-your-own project using C++. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 编程语言
- **Language / stack**: C++
- **Original resource**: https://www.youtube.com/watch?v=eF9qWbuQLuw
