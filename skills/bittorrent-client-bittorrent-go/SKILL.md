---
name: bittorrent-client-bittorrent-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for BitTorrent 客户端 using Go. Use when they mention "build your own bittorrent-client", "用 Go 从底层开始构建 BitTorrent 客户端", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Language / stack**: Go
- **Original resource**: https://blog.jse.li/posts/torrent/
