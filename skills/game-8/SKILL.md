...
name: game-8
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using JavaScript. Use when they mention "build your own game", "从零构建你自己的 8 号球台球游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.youtube.com/watch?v=aXwCrtAo4Wc
