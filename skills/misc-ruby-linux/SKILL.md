---
name: misc-ruby-linux
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Ruby. Use when they mention "build your own misc", "用 Ruby 创建 Linux 桌面应用", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: Ruby
- **Original resource**: https://iridakos.com/tutorials/2018/01/25/creating-a-gtk-todo-application-with-ruby
