---
name: operating-system-linux-from-scratch
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using (any). Use when they mention "build your own operating-system", "Linux From Scratch", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: (any)
- **Original resource**: https://linuxfromscratch.org/lfs
