---
name: blockchain-cryptocurrency-blockchain-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Ruby. Use when they mention "build your own blockchain-cryptocurrency", "一步步编程实现区块链（手稿/书籍版）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Ruby
- **Original resource**: https://github.com/yukimotopress/programming-blockchains-step-by-step
