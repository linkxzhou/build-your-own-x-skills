---
name: programming-language-compiler-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using C. Use when they mention "build your own programming-language", "一段从零构建编译器的旅程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: C
- **Original resource**: https://github.com/DoctorWkt/acwj
