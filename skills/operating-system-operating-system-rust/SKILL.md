---
name: operating-system-operating-system-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend "RISC-V 的 Rust 操作系统教程" or a 操作系统 build-your-own project using Rust. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# RISC-V 的 Rust 操作系统教程
