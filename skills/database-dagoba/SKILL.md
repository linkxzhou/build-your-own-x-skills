---
name: database-dagoba
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using JavaScript. Use when they mention "build your own database", "Dagoba：内存图数据库", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://aosabook.org/en/500L/dagoba-an-in-memory-graph-database.html
