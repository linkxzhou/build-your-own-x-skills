---
name: bittorrent-client-bittorrent-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for BitTorrent 客户端 using Python. Use when they mention "build your own bittorrent-client", "Python 3.5 的 BitTorrent 客户端", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://markuseliasson.se/article/bittorrent-in-python/
