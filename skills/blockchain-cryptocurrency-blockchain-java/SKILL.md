---
name: blockchain-cryptocurrency-blockchain-java
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Java. Use when they mention "build your own blockchain-cryptocurrency", "用 Java 创建你的第一条区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Java
- **Original resource**: https://medium.com/programmers-blockchain/create-simple-blockchain-java-tutorial-from-scratch-6eeed3cb03fa
