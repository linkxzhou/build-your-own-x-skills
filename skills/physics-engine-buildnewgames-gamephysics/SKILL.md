---
name: physics-engine-buildnewgames-gamephysics
description: |
  Trigger when the user wants to learn, implement, debug, or extend "物理引擎如何工作" or a 物理引擎 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: http://buildnewgames.com/gamephysics/
