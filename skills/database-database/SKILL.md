...
description: |
  Trigger when the user wants to learn, implement, debug, or extend "来构建一个简单数据库" or a 数据库 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 数据库
- **Language / stack**: C
- **Original resource**: https://cstack.github.io/db_tutorial/
