---
name: physics-engine-allen-chou
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 物理引擎 using C++. Use when they mention "build your own physics-engine", "Allen Chou 的游戏物理系列", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 物理引擎
- **Language / stack**: C++
- **Original resource**: http://allenchou.net/game-physics-series/
