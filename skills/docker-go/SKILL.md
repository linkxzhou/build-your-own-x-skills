...
name: docker-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Docker using Go. Use when they mention "build your own docker", "用 Go 从零构建容器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Docker
- **Language / stack**: Go
- **Original resource**: https://www.youtube.com/watch?v=8fi7uSYlOdc
