---
name: augmented-reality-ar-arkit
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 增强现实（AR） using C#. Use when they mention "build your own augmented-reality", "AR 教程：ARKit 传送门通往“颠倒世界”", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 增强现实（AR）
- **Language / stack**: C#
- **Original resource**: https://www.youtube.com/watch?v=Z5AmqMuNi08
