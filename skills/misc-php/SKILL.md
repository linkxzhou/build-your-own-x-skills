...
name: misc-php
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using PHP. Use when they mention "build your own misc", "没有框架的现代 PHP", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: PHP
- **Original resource**: https://kevinsmith.io/modern-php-without-a-framework
