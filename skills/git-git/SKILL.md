...
name: git-git
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Git using Haskell. Use when they mention "build your own git", "用 Haskell 从底层重实现 “git clone”", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://stefan.saasen.me/articles/git-clone-in-haskell-from-the-bottom-up/
