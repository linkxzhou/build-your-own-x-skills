---
name: frontend-framework-library-react-pomb-us-react
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建你自己的 React" or a 前端框架 / 库 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://pomb.us/build-your-own-react/
