---
name: programming-language-journal-stuffwithstuff-2013-12
description: |
  Trigger when the user wants to learn, implement, debug, or extend "宝宝的第一个垃圾回收器" or a 编程语言 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 编程语言
- **Language / stack**: C
- **Original resource**: http://journal.stuffwithstuff.com/2013/12/08/babys-first-garbage-collector/
