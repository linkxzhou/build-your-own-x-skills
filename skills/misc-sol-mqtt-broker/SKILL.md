---
name: misc-sol-mqtt-broker
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C. Use when they mention "build your own misc", "Sol：从零实现 MQTT Broker", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C
- **Original resource**: https://codepr.github.io/posts/sol-mqtt-broker
