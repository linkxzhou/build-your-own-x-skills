---
name: command-line-tool-git
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Go. Use when they mention "build your own command-line-tool", "用 Go 可视化本地 Git 贡献", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Go
- **Original resource**: https://flaviocopes.com/go-git-contributions/
