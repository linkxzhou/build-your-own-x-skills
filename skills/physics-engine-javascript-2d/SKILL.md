---
name: physics-engine-javascript-2d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 物理引擎 using JavaScript. Use when they mention "build your own physics-engine", "为 JavaScript 游戏构建一个简单 2D 物理引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://developer.ibm.com/tutorials/wa-build2dphysicsengine/?mhsrc=ibmsearch_a&mhq=2dphysic
