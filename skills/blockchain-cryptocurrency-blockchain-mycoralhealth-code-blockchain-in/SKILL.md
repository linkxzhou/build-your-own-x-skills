---
name: blockchain-cryptocurrency-blockchain-mycoralhealth-code-blockchain-in
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用不到 200 行 Go 写出你自己的区块链" or a 区块链 / 加密货币 build-your-own project using Go. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 用不到 200 行 Go 写出你自己的区块链
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Go
- **Original resource**: https://medium.com/@mycoralhealth/code-your-own-blockchain-in-less-than-200-lines-of-go-e296282bcffc
