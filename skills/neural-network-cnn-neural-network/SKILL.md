---
name: neural-network-cnn-neural-network
description: |
  Trigger when the user wants to learn, implement, debug, or extend "卷积神经网络（CNN）入门" or a 神经网络 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://victorzhou.com/blog/intro-to-cnns-part-1/
