---
name: frontend-framework-library-react-ci
description: |
  Trigger when the user wants to learn, implement, debug, or extend "通过构建轻量 React DOM 来理解 React Reconciler 如何工作" or a 前端框架 / 库 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 通过构建轻量 React DOM 来理解 React Reconciler 如何工作
...
- **Original resource**: https://hackernoon.com/learn-you-some-custom-react-renderers-aed7164a4199
