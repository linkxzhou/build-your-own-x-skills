---
name: web-server-web-ruslanspivak-lsbaws-part1
description: |
  Trigger when the user wants to learn, implement, debug, or extend "让我们构建一个 Web 服务器" or a Web 服务器 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://ruslanspivak.com/lsbaws-part1/
