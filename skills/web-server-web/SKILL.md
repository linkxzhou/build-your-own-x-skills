...
name: web-server-web
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using C#. Use when they mention "build your own web-server", "从零编写 Web 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Web 服务器
- **Language / stack**: C#
- **Original resource**: https://www.codeproject.com/Articles/859108/Writing-a-Web-Server-from-Scratch
