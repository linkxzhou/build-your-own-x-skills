---
name: template-engine-template-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模板引擎 using JavaScript. Use when they mention "build your own template-engine", "理解 JavaScript 微模板（Micro-Templating）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://medium.com/wdstack/understanding-javascript-micro-templating-f37a37b3b40e
