# Tutorial map: 理解 JavaScript 微模板（Micro-Templating）

## Original resource

- URL: https://medium.com/wdstack/understanding-javascript-micro-templating-f37a37b3b40e
...
- Keep the implementation idiomatic for JavaScript.
