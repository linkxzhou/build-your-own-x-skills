---
name: physics-engine-buildnewgames-broad-phase-collision
description: |
  Trigger when the user wants to learn, implement, debug, or extend "使用空间划分的广义阶段碰撞检测" or a 物理引擎 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: http://buildnewgames.com/broad-phase-collision-detection/
