...
name: game-pygame
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Python. Use when they mention "build your own game", "用 PyGame 开发游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://pythonprogramming.net/pygame-python-3-part-1-intro/
