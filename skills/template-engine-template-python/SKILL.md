---
name: template-engine-template-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模板引擎 using Python. Use when they mention "build your own template-engine", "方法：用 Python 构建玩具模板引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://alexmic.net/building-a-template-engine/
