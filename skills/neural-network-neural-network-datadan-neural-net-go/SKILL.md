---
name: neural-network-neural-network-datadan-neural-net-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用 Go 从零构建神经网络" or a 神经网络 build-your-own project using Go. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 神经网络
- **Language / stack**: Go
- **Original resource**: https://datadan.io/blog/neural-net-with-go
