---
name: frontend-framework-library-redux-egghead-lessons-react-redux
description: |
  Trigger when the user wants to learn, implement, debug, or extend "Redux：从零实现 Store" or a 前端框架 / 库 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://egghead.io/lessons/react-redux-implementing-store-from-scratch
