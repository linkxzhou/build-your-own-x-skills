...
name: misc-cdn-cdn
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Lua. Use when they mention "build your own misc", "从零构建 CDN 来学习 CDN", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: Lua
- **Original resource**: https://github.com/leandromoreira/cdn-up-and-running
...
2. Detect the target language/toolchain. Default to **Lua** when the user does not specify another stack.
