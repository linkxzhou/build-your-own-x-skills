---
name: programming-language-lisp-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using C. Use when they mention "build your own programming-language", "构建你自己的 Lisp：用 1000 行代码学习 C 并写出语言", the source URL, or ask for a Claude Code guided implementation plan.
...
# 构建你自己的 Lisp：用 1000 行代码学习 C 并写出语言
...
- **Category**: 编程语言
- **Language / stack**: C
- **Original resource**: http://www.buildyourownlisp.com/
