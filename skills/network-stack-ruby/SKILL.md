---
name: network-stack-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 网络协议栈 using Ruby. Use when they mention "build your own network-stack", "如何用 Ruby 构建网络协议栈", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 网络协议栈
- **Language / stack**: Ruby
- **Original resource**: https://medium.com/geckoboard-under-the-hood/how-to-build-a-network-stack-in-ruby-f73aeb1b661b
