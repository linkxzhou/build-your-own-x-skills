---
name: misc-untrod-2016-06-simple
description: |
  Trigger when the user wants to learn, implement, debug, or extend "一个简单的基于内容的推荐引擎" or a 未分类 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: http://blog.untrod.com/2016/06/simple-similar-products-recommendation-engine-in-python.html
