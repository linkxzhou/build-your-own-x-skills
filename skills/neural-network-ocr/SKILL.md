---
name: neural-network-ocr
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using Python. Use when they mention "build your own neural-network", "光学字符识别（OCR）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://aosabook.org/en/500L/optical-character-recognition-ocr.html
