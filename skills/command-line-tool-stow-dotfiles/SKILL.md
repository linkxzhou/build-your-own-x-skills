---
name: command-line-tool-stow-dotfiles
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Nim. Use when they mention "build your own command-line-tool", "编写 stow 的替代方案来管理 dotfiles", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Nim
- **Original resource**: https://xmonader.github.io/nimdays/day06_nistow.html
...
2. Detect the target language/toolchain. Default to **Nim** when the user does not specify another stack.
