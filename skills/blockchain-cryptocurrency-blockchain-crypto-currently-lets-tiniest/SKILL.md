---
name: blockchain-cryptocurrency-blockchain-crypto-currently-lets-tiniest
description: |
  Trigger when the user wants to learn, implement, debug, or extend "来构建最小的区块链" or a 区块链 / 加密货币 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://medium.com/crypto-currently/lets-build-the-tiniest-blockchain-e70965a248b
