---
name: database-45-tdd
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Go. Use when they mention "build your own database", "45 步写数据库：一系列以 TDD 为主的小型编码谜题", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 数据库
- **Language / stack**: Go
- **Original resource**: https://trialofcode.org/database/
