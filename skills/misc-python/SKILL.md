...
name: misc-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Python. Use when they mention "build your own misc", "Python 推荐系统：入门教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.datacamp.com/community/tutorials/recommender-systems-python
