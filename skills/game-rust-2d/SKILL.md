...
name: game-rust-2d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Rust. Use when they mention "build your own game", "Rust 冒险：一个基础 2D 游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Rust
- **Original resource**: https://a5huynh.github.io/posts/2018/adventures-in-rust/
