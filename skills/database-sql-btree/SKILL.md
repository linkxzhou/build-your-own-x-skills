---
name: database-sql-btree
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Go. Use when they mention "build your own database", "从零构建数据库：从 B+Tree 到 SQL，3000 行实现", the source URL, or ask for a Claude Code guided implementation plan.
...
# 从零构建数据库：从 B+Tree 到 SQL，3000 行实现
...
- **Category**: 数据库
- **Language / stack**: Go
- **Original resource**: https://build-your-own.org/database/
