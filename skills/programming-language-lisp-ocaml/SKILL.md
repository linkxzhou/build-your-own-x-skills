---
name: programming-language-lisp-ocaml
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using OCaml. Use when they mention "build your own programming-language", "写 Lisp 系列", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://bernsteinbear.com/blog/lisp/
