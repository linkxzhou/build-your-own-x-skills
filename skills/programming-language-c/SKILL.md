...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using C. Use when they mention "build your own programming-language", "用 C 编写一个简单垃圾回收器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: C
- **Original resource**: http://maplant.com/gc.html
