...
name: 3d-renderer-3d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using C++. Use when they mention "build your own 3d-renderer", "《德军总部 3D》射线投射引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 3D 渲染器
- **Language / stack**: C++
- **Original resource**: http://lodev.org/cgtutor/raycasting.html
