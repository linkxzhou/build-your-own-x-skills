...
name: bot-bot
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 机器人（Bot） using Haskell. Use when they mention "build your own bot", "自己做一个 IRC 机器人", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://wiki.haskell.org/Roll_your_own_IRC_bot
