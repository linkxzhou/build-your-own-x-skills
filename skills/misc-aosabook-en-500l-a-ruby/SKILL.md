---
name: misc-aosabook-en-500l-a-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend "现实世界里的计步器" or a 未分类 build-your-own project using Ruby. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Ruby
- **Original resource**: http://aosabook.org/en/500L/a-pedometer-in-the-real-world.html
