...
name: game-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Go. Use when they mention "build your own game", "用 Go 做游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Go
- **Original resource**: https://www.youtube.com/playlist?list=PLDZujg-VgQlZUy1iCqBbe5faZLMkA3g2x
...
2. Detect the target language/toolchain. Default to **Go** when the user does not specify another stack.
