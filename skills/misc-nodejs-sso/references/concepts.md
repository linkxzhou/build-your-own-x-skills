# Concepts checklist: 用 Node.js 从零构建一个简单 SSO 服务与方案
...
- Source: https://codeburst.io/building-a-simple-single-sign-on-sso-server-and-solution-from-scratch-in-node-js-ea6ee5fdf340
