---
name: regex-engine-regex
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using C. Use when they mention "build your own regex-engine", "正则表达式匹配器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 正则表达式引擎
- **Language / stack**: C
- **Original resource**: https://www.cs.princeton.edu/courses/archive/spr09/cos333/beautiful.html
