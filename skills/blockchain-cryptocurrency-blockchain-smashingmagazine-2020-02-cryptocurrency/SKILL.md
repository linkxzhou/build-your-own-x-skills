---
name: blockchain-cryptocurrency-blockchain-smashingmagazine-2020-02-cryptocurrency
description: |
  Trigger when the user wants to learn, implement, debug, or extend "在 Node.js 中编写区块链" or a 区块链 / 加密货币 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://www.smashingmagazine.com/2020/02/cryptocurrency-blockchain-node-js/
