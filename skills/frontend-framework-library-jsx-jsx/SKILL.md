---
name: frontend-framework-library-jsx-jsx
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 前端框架 / 库 using JavaScript. Use when they mention "build your own frontend-framework-library", "JSX 到底是什么（让我们构建一个 JSX 渲染器）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://jasonformat.com/wtf-is-jsx/
