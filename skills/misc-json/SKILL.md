...
name: misc-json
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Python. Use when they mention "build your own misc", "JSON 解码算法", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/cheery/json-algorithm
