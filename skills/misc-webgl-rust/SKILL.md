---
name: misc-webgl-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Rust. Use when they mention "build your own misc", "WebGL + Rust：基础水面教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: Rust
- **Original resource**: https://www.chinedufn.com/3d-webgl-basic-water-tutorial/
