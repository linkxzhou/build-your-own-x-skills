---
name: frontend-framework-library-virtual-dom
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 前端框架 / 库 using JavaScript. Use when they mention "build your own frontend-framework-library", "如何实现你自己的 Virtual DOM", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://medium.com/@deathmood/how-to-write-your-own-virtual-dom-ee74acc13060
