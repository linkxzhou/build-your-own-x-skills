---
name: misc-xmonader-nimdays-day04-asynclinkschecker
description: |
  Trigger when the user wants to learn, implement, debug, or extend "编写链接检查器" or a 未分类 build-your-own project using Nim. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Nim
- **Original resource**: https://xmonader.github.io/nimdays/day04_asynclinkschecker.html

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `Nim` unless the user chooses another stack.
