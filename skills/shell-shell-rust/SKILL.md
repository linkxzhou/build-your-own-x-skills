---
name: shell-shell-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Shell using Rust. Use when they mention "build your own shell", "使用 Rust 构建你自己的 Shell", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Shell
- **Language / stack**: Rust
- **Original resource**: https://www.joshmcguigan.com/blog/build-your-own-shell-rust/
