---
name: augmented-reality-vuforia-unity-3d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 增强现实（AR） using C#. Use when they mention "build your own augmented-reality", "入门教程：使用 Vuforia 与 Unity 3D 的增强现实应用", the source URL, or ask for a Claude Code guided implementation plan.
...
# 入门教程：使用 Vuforia 与 Unity 3D 的增强现实应用
...
- **Category**: 增强现实（AR）
- **Language / stack**: C#
- **Original resource**: https://www.youtube.com/watch?v=uXNjNcqW4kY
