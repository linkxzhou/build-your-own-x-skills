---
name: search-engine-redis-search
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 搜索引擎 using Python. Use when they mention "build your own search-engine", "用 Redis 与 redis-py 构建搜索引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://www.dr-josiah.com/2010/07/building-search-engine-using-redis-and.html
