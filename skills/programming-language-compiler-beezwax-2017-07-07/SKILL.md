---
name: programming-language-compiler-beezwax-2017-07-07
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用 Ruby 从零写 Markdown 编译器" or a 编程语言 build-your-own project using Ruby. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 用 Ruby 从零写 Markdown 编译器
...
- **Category**: 编程语言
- **Language / stack**: Ruby
- **Original resource**: https://blog.beezwax.net/2017/07/07/writing-a-markdown-compiler/

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `Ruby` unless the user chooses another stack.
