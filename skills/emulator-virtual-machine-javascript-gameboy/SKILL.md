---
name: emulator-virtual-machine-javascript-gameboy
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using JavaScript. Use when they mention "build your own emulator-virtual-machine", "用 JavaScript 做 GameBoy 模拟", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://imrannazar.com/GameBoy-Emulation-in-JavaScript
