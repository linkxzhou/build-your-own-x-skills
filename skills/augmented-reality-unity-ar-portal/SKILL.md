---
name: augmented-reality-unity-ar-portal
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 增强现实（AR） using C#. Use when they mention "build your own augmented-reality", "Unity AR 传送门（Portal）教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 增强现实（AR）
- **Language / stack**: C#
- **Original resource**: https://www.youtube.com/playlist?list=PLPCqNOwwN794Gz5fzUSi1p4OqLU0HTmvn
...
2. Detect the target language/toolchain. Default to **C#** when the user does not specify another stack.
