---
name: programming-language-compiler-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using JavaScript. Use when they mention "build your own programming-language", "超小编译器（The Super Tiny Compiler）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/jamiebuilds/the-super-tiny-compiler
