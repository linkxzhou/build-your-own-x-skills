---
name: frontend-framework-library-angular
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 前端框架 / 库 using JavaScript. Use when they mention "build your own frontend-framework-library", "200 行 JavaScript 实现一个简化版 AngularJS", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://blog.mgechev.com/2015/03/09/build-learn-your-own-light-lightweight-angularjs/
