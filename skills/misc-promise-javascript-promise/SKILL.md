---
name: misc-promise-javascript-promise
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using JavaScript. Use when they mention "build your own misc", "通过自己实现 Promise 来理解 JavaScript Promise", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://levelup.gitconnected.com/understand-javascript-promises-by-building-a-promise-from-scratch-84c0fd855720
