---
name: blockchain-cryptocurrency-1500
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using JavaScript. Use when they mention "build your own blockchain-cryptocurrency", "少于 1500 行代码的加密货币实现", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/conradoqg/naivecoin
