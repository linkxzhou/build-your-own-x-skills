---
name: game-rust-tcod-roguelike
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Rust. Use when they mention "build your own game", "Rust + tcod 的 Roguelike 教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Rust
- **Original resource**: https://tomassedovic.github.io/roguelike-tutorial/
