...
name: shell-shell-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Shell using Go. Use when they mention "build your own shell", "用 Go 写一个简单 Shell", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Shell
- **Language / stack**: Go
- **Original resource**: https://sj14.gitlab.io/post/2018-07-01-go-unix-shell/
