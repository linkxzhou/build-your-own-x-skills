...
name: misc-linux
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C++. Use when they mention "build your own misc", "编写 Linux 调试器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C++
- **Original resource**: https://blog.tartanllama.xyz/writing-a-linux-debugger-setup/
