---
name: game-let-s-make-dangerous-dave
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C. Use when they mention "build your own game", "Let's Make: Dangerous Dave", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C
- **Original resource**: https://www.youtube.com/playlist?list=PLSkJey49cOgTSj465v2KbLZ7LMn10bCF9
