---
name: network-stack-vpn
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 网络协议栈 using C / Python. Use when they mention "build your own network-stack", "构建你自己的 VPN/虚拟交换机", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 网络协议栈
- **Language / stack**: C / Python
- **Original resource**: https://github.com/peiyuanix/build-your-own-zerotier
...
2. Detect the target language/toolchain. Default to **C / Python** when the user does not specify another stack.
