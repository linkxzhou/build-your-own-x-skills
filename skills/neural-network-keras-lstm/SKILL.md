---
name: neural-network-keras-lstm
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using Python. Use when they mention "build your own neural-network", "用 Keras 的 LSTM 生成音乐", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://towardsdatascience.com/how-to-generate-music-using-a-lstm-neural-network-in-keras-68786834d4c5
