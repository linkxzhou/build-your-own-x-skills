---
name: programming-language-lisp-swift
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Swift. Use when they mention "build your own programming-language", "用 Swift 从零构建 Lisp", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.uraimo.com/2017/02/05/building-a-lisp-from-scratch-with-swift/
...
2. Detect the target language/toolchain. Default to **Swift** when the user does not specify another stack.
