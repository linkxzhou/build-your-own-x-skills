...
name: misc-manim
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using General. Use when they mention "build your own misc", "生成 manim 视频", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/ManimCommunity/Manim
- **Original status**: already marked complete in README
