---
name: misc-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using JavaScript. Use when they mention "build your own misc", "JavaScript 算法与数据结构", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/trekhleb/javascript-algorithms
