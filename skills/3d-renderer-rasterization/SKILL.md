---
name: 3d-renderer-rasterization
description: |
  Trigger when the user wants to learn, implement, debug, or extend "光栅化：一次实用实现" or a 3D 渲染器 build-your-own project using C++. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 3D 渲染器
- **Language / stack**: C++
- **Original resource**: https://www.scratchapixel.com/lessons/3d-basic-rendering/rasterization-practical-implementation/overview-rasterization-algorithm
