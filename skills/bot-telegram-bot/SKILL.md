...
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何制作一个响应式的 Telegram 机器人" or a 机器人（Bot） build-your-own project using Node.js. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 如何制作一个响应式的 Telegram 机器人
...
- **Original resource**: https://www.sohamkamani.com/blog/2016/09/21/making-a-telegram-bot/
