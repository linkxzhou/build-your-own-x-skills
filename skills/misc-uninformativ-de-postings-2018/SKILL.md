---
name: misc-uninformativ-de-postings-2018
description: |
  Trigger when the user wants to learn, implement, debug, or extend "终端模拟器的基础知识" or a 未分类 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: C
- **Original resource**: https://www.uninformativ.de/blog/postings/2018-02-24/0/POSTING-en.html
