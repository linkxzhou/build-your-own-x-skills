...
name: misc-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C. Use when they mention "build your own misc", "学习如何用 C 写哈希表", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C
- **Original resource**: https://github.com/jamesroutley/write-a-hash-table
