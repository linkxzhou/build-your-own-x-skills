---
name: misc-csharp-tcp-tcp-udp-pong
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C#. Use when they mention "build your own misc", "C# 网络编程：TCP 聊天服务端、TCP 游戏、UDP Pong 等", the source URL, or ask for a Claude Code guided implementation plan.
...
# C# 网络编程：TCP 聊天服务端、TCP 游戏、UDP Pong 等
...
- **Category**: 未分类
- **Language / stack**: C#
- **Original resource**: https://16bpp.net/tutorials/csharp-networking
