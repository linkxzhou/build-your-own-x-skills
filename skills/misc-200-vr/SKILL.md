...
name: misc-200-vr
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C++. Use when they mention "build your own misc", "用 200 美元构建你自己的 VR 头显", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C++
- **Original resource**: https://github.com/relativty/Relativ
