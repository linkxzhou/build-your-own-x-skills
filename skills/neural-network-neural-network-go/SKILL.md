---
name: neural-network-neural-network-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using Go. Use when they mention "build your own neural-network", "如何用 Go 构建一个简单的人工神经网络", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 神经网络
- **Language / stack**: Go
- **Original resource**: https://sausheong.github.io/posts/how-to-build-a-simple-artificial-neural-network-with-go/
