...
name: bot-bot-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 机器人（Bot） using Rust. Use when they mention "build your own bot", "用 Rust（或 C 等）为《星际争霸》写一个机器人", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 机器人（Bot）
- **Language / stack**: Rust
- **Original resource**: https://habr.com/en/post/436254/
