---
name: physics-engine-gamedevelopment-tutsplus-series-create
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何创建自定义物理引擎" or a 物理引擎 build-your-own project using C++. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 物理引擎
- **Language / stack**: C++
- **Original resource**: https://gamedevelopment.tutsplus.com/series/how-to-create-a-custom-physics-engine--gamedev-12715
