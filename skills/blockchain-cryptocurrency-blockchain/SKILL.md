---
name: blockchain-cryptocurrency-blockchain
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using ATS. Use when they mention "build your own blockchain-cryptocurrency", "函数式区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: ATS
- **Original resource**: https://beta.observablehq.com/@galletti94/functional-blockchain
...
2. Detect the target language/toolchain. Default to **ATS** when the user does not specify another stack.
