---
name: programming-language-compiler-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Python. Use when they mention "build your own programming-language", "从源代码到机器码：从零构建你自己的编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://build-your-own.org/compiler/
