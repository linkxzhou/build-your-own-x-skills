...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Docker using Python. Use when they mention "build your own docker", "一个 Docker 的概念验证替代品（100% Python）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://github.com/tonybaloney/mocker
