---
name: emulator-virtual-machine-gameboy-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using Rust. Use when they mention "build your own emulator-virtual-machine", "0dmg：通过构建部分 Game Boy 模拟器学习 Rust", the source URL, or ask for a Claude Code guided implementation plan.
...
# 0dmg：通过构建部分 Game Boy 模拟器学习 Rust
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: Rust
- **Original resource**: https://jeremybanks.github.io/0dmg/
