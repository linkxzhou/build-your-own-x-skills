---
name: bittorrent-client-bittorrent
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for BitTorrent 客户端 using C#. Use when they mention "build your own bittorrent-client", "用 C# 从零构建 BitTorrent 客户端", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Language / stack**: C#
- **Original resource**: https://www.seanjoflynn.com/research/bittorrent.html
