---
name: blockchain-cryptocurrency-blockchain-savjeetutorials-savjeecoin
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用 JavaScript 创建区块链" or a 区块链 / 加密货币 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://github.com/SavjeeTutorials/SavjeeCoin
