...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 搜索引擎 using CSS. Use when they mention "build your own search-engine", "用 CSS 做一个搜索引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 搜索引擎
- **Language / stack**: CSS
- **Original resource**: https://stories.algolia.com/a-search-engine-in-css-b5ec4e902e97
...
2. Detect the target language/toolchain. Default to **CSS** when the user does not specify another stack.
