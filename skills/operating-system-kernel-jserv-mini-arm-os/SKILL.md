---
name: operating-system-kernel-jserv-mini-arm-os
description: |
  Trigger when the user wants to learn, implement, debug, or extend "从零为 ARM 构建一个最小多任务内核" or a 操作系统 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://github.com/jserv/mini-arm-os
