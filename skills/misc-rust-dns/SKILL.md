...
name: misc-rust-dns
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Rust. Use when they mention "build your own misc", "用 Rust 构建 DNS 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: Rust
- **Original resource**: https://github.com/EmilHernvall/dnsguide/blob/master/README.md
