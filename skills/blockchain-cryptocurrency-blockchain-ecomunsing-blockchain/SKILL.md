---
name: blockchain-cryptocurrency-blockchain-ecomunsing-blockchain
description: |
  Trigger when the user wants to learn, implement, debug, or extend "自己动手构建区块链：Python 教程" or a 区块链 / 加密货币 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: http://ecomunsing.com/build-your-own-blockchain
