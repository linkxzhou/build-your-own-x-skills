---
name: misc-nodejs-dns
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Node.js. Use when they mention "build your own misc", "用 Node.js 构建 DNS 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://engineerhead.github.io/dns-server/
