---
name: regex-engine-regex-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using Python. Use when they mention "build your own regex-engine", "构建你自己的正则引擎：回溯、NFA、DFA", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://build-your-own.org/b2a/r0_intro
