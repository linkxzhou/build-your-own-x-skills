---
name: emulator-virtual-machine-justinmeiners-lc3-vm
description: |
  Trigger when the user wants to learn, implement, debug, or extend "编写你自己的虚拟机" or a 模拟器 / 虚拟机 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: C
- **Original resource**: https://justinmeiners.github.io/lc3-vm/
