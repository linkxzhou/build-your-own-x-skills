---
name: neural-network-neural-network-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using Python. Use when they mention "build your own neural-network", "11 行 Python 的神经网络", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://iamtrask.github.io/2015/07/12/basic-python-network/
