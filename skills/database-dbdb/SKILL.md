...
name: database-dbdb
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Python. Use when they mention "build your own database", "DBDB：狗窝数据库", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://aosabook.org/en/500L/dbdb-dog-bed-database.html
