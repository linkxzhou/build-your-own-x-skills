---
name: blockchain-cryptocurrency-blockchain-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Python. Use when they mention "build your own blockchain-cryptocurrency", "通过构建来学习区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://hackernoon.com/learn-blockchains-by-building-one-117428612f46
