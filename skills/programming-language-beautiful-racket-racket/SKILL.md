---
name: programming-language-beautiful-racket-racket
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Racket. Use when they mention "build your own programming-language", "Beautiful Racket：如何用 Racket 制作自己的编程语言", the source URL, or ask for a Claude Code guided implementation plan.
...
# Beautiful Racket：如何用 Racket 制作自己的编程语言
...
- **Category**: 编程语言
- **Language / stack**: Racket
- **Original resource**: https://beautifulracket.com/
...
2. Detect the target language/toolchain. Default to **Racket** when the user does not specify another stack.
