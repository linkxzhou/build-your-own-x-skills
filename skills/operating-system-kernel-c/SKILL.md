...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using C. Use when they mention "build your own operating-system", "Kernel 201：写一个带键盘与屏幕支持的内核", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://arjunsreedharan.org/post/99370248137/kernel-201-lets-write-a-kernel-with-keyboard
