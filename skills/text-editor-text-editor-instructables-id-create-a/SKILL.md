---
name: text-editor-text-editor-instructables-id-create-a
description: |
  Trigger when the user wants to learn, implement, debug, or extend "创建一个简单的 Python 文本编辑器！" or a 文本编辑器 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 创建一个简单的 Python 文本编辑器！
...
- **Original resource**: http://www.instructables.com/id/Create-a-Simple-Python-Text-Editor/
