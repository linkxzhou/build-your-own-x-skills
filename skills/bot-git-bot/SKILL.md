...
name: bot-git-bot
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 机器人（Bot） using Node.js. Use when they mention "build your own bot", "gifbot：构建一个 GitHub App", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://blog.scottlogic.com/2017/05/22/gifbot-github-integration.html
