---
name: network-stack-beej
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 网络协议栈 using C. Use when they mention "build your own network-stack", "Beej 的网络编程指南", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 网络协议栈
- **Language / stack**: C
- **Original resource**: http://beej.us/guide/bgnet/
