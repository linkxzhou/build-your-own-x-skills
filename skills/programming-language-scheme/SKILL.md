---
name: programming-language-scheme
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Haskell. Use when they mention "build your own programming-language", "48 小时写一个 Scheme", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: Haskell
- **Original resource**: https://en.wikibooks.org/wiki/Write_Yourself_a_Scheme_in_48_Hours
...
2. Detect the target language/toolchain. Default to **Haskell** when the user does not specify another stack.
