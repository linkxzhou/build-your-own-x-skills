---
name: misc-tiny-package-manager-npm-yarn
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using TypeScript. Use when they mention "build your own misc", "Tiny Package Manager：学习 npm / Yarn 的工作方式", the source URL, or ask for a Claude Code guided implementation plan.
...
# Tiny Package Manager：学习 npm / Yarn 的工作方式
...
- **Original resource**: https://github.com/g-plane/tiny-package-manager
