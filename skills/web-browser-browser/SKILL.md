---
name: web-browser-browser
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 网页浏览器 using Rust. Use when they mention "build your own web-browser", "让我们构建一个浏览器引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 网页浏览器
- **Language / stack**: Rust
- **Original resource**: https://limpet.net/mbrubeck/2014/08/08/toy-layout-engine-1.html
