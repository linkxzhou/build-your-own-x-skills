---
name: programming-language-compiler-haskell
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Haskell. Use when they mention "build your own programming-language", "让我们构建一个编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://g-ford.github.io/cradle/
