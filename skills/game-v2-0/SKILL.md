...
name: game-v2-0
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C++. Use when they mention "build your own game", "入门游戏编程 v2.0", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C++
- **Original resource**: http://lazyfoo.net/tutorials/SDL/
