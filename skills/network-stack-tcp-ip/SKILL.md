...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 网络协议栈 using C. Use when they mention "build your own network-stack", "让我们写一个 TCP/IP 协议栈", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 网络协议栈
- **Language / stack**: C
- **Original resource**: http://www.saminiir.com/lets-code-tcp-ip-stack-1-ethernet-arp/
