---
name: text-editor-text-editor-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 文本编辑器 using Python. Use when they mention "build your own text-editor", "Python 教程：制作你自己的文本编辑器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.youtube.com/watch?v=xqDonHEYPgA
