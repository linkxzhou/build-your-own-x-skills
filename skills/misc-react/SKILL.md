...
name: misc-react
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using JavaScript. Use when they mention "build your own misc", "用 React Native 构建网约车应用", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://pusher.com/tutorials/ride-hailing-react-native
