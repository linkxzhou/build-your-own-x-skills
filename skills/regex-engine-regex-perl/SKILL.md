---
name: regex-engine-regex-perl
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using Perl. Use when they mention "build your own regex-engine", "正则是如何工作的", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 正则表达式引擎
- **Language / stack**: Perl
- **Original resource**: https://perl.plover.com/Regex/article.html
...
2. Detect the target language/toolchain. Default to **Perl** when the user does not specify another stack.
