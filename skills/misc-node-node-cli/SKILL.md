---
name: misc-node-node-cli
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Node.js. Use when they mention "build your own misc", "如何用 Node 创建一个真实世界的 Node CLI 应用", the source URL, or ask for a Claude Code guided implementation plan.
...
# 如何用 Node 创建一个真实世界的 Node CLI 应用
...
- **Original resource**: https://medium.freecodecamp.org/how-to-create-a-real-world-node-cli-app-with-node-391b727bbed3
