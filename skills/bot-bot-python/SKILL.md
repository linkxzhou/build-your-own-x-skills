...
name: bot-bot-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 机器人（Bot） using Python. Use when they mention "build your own bot", "如何用 Python 构建你的第一个 Slack 机器人", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://www.fullstackpython.com/blog/build-first-slack-bot-python.html
