---
name: programming-language-compiler-cpp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using C++. Use when they mention "build your own programming-language", "用 Flex 编写你自己的玩具编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: C++
- **Original resource**: https://gnuu.org/2009/09/18/writing-your-own-toy-compiler/
