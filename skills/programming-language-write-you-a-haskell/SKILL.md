---
name: programming-language-write-you-a-haskell
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Haskell. Use when they mention "build your own programming-language", "Write You a Haskell", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://dev.stephendiehl.com/fun/
