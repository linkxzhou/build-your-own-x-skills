---
name: voxel-engine-voxel
description: |
  Trigger when the user wants to learn, implement, debug, or extend "让我们做一个体素引擎" or a 体素引擎（Voxel Engine） build-your-own project using C++. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 体素引擎（Voxel Engine）
- **Language / stack**: C++
- **Original resource**: https://sites.google.com/site/letsmakeavoxelengine/home
