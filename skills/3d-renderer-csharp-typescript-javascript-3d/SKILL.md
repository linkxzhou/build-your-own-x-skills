---
name: 3d-renderer-csharp-typescript-javascript-3d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using C# / TypeScript / JavaScript. Use when they mention "build your own 3d-renderer", "从零学习用 C#、TypeScript 或 JavaScript 编写 3D 软渲染引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 3D 渲染器
- **Language / stack**: C# / TypeScript / JavaScript
- **Original resource**: https://www.davrous.com/2013/06/13/tutorial-series-learning-how-to-write-a-3d-soft-engine-from-scratch-in-c-typescript-or-javascript/
...
2. Detect the target language/toolchain. Default to **C# / TypeScript / JavaScript** when the user does not specify another stack.
