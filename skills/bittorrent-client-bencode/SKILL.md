---
name: bittorrent-client-bencode
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for BitTorrent 客户端 using Nim. Use when they mention "build your own bittorrent-client", "编写一个 Bencode 解析器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Language / stack**: Nim
- **Original resource**: https://xmonader.github.io/nimdays/day02_bencode.html
