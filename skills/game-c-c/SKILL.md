...
name: game-c-c
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C. Use when they mention "build your own game", "用 C 学习游戏编程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C
- **Original resource**: https://www.youtube.com/playlist?list=PLT6WFYYZE6uLMcPGS3qfpYm7T_gViYMMt
