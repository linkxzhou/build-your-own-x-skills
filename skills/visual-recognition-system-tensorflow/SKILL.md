---
name: visual-recognition-system-tensorflow
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 视觉识别系统 using Python. Use when they mention "build your own visual-recognition-system", "用 Tensorflow 深度学习构建人脸识别流水线", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://hackernoon.com/building-a-facial-recognition-pipeline-with-deep-learning-in-tensorflow-66e7645015b8
