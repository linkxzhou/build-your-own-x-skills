---
name: web-browser-browser-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 网页浏览器 using Python. Use when they mention "build your own web-browser", "Browser Engineering", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://browser.engineering
