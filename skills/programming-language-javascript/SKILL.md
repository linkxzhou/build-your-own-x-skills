---
name: programming-language-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using JavaScript. Use when they mention "build your own programming-language", "如何用 JavaScript 实现一门编程语言", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://lisperator.net/pltut/
