---
name: 3d-renderer-opengl-500
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using C++. Use when they mention "build your own 3d-renderer", "OpenGL 如何工作：500 行代码实现软件渲染", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 3D 渲染器
- **Language / stack**: C++
- **Original resource**: https://github.com/ssloy/tinyrenderer/wiki
