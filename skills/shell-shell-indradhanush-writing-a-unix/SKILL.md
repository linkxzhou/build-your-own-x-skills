---
name: shell-shell-indradhanush-writing-a-unix
description: |
  Trigger when the user wants to learn, implement, debug, or extend "编写 UNIX Shell" or a Shell build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: Shell
- **Language / stack**: C
- **Original resource**: https://indradhanush.github.io/blog/writing-a-unix-shell-part-1/
