...
name: misc-url
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Nim. Use when they mention "build your own misc", "编写 URL 短链接服务", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: Nim
- **Original resource**: https://xmonader.github.io/nimdays/day07_shorturl.html
