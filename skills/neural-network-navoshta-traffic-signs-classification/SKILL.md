---
name: neural-network-navoshta-traffic-signs-classification
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用卷积网络进行交通标志分类" or a 神经网络 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://navoshta.com/traffic-signs-classification/
