...
name: misc-64k-intro
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C++. Use when they mention "build your own misc", "一个 64k intro 是如何制作的", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C++
- **Original resource**: http://www.lofibucket.com/articles/64k_intro.html
