---
name: command-line-tool-zig-cli
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Zig. Use when they mention "build your own command-line-tool", "从零用 Zig 构建你的 CLI 应用", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Zig
- **Original resource**: https://rebuild-x.github.io/docs/#/./zig/terminal/cli
...
2. Detect the target language/toolchain. Default to **Zig** when the user does not specify another stack.
