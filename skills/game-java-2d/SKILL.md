...
name: game-java-2d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Java. Use when they mention "build your own game", "用 Java 写 2D 游戏引擎（完整入门课）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Java
- **Original resource**: https://www.youtube.com/watch?v=025QFeZfeyM
