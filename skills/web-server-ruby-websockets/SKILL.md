---
name: web-server-ruby-websockets
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Ruby. Use when they mention "build your own web-server", "用 Ruby 从零构建简单 websockets 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Web 服务器
- **Language / stack**: Ruby
- **Original resource**: http://blog.honeybadger.io/building-a-simple-websockets-server-from-scratch-in-ruby/
...
2. Detect the target language/toolchain. Default to **Ruby** when the user does not specify another stack.
