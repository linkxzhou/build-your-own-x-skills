---
name: git-git-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Git using JavaScript. Use when they mention "build your own git", "Gitlet", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://gitlet.maryrosecook.com/docs/gitlet.html
