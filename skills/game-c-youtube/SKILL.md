...
name: game-c-youtube
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用 C 编写数独求解器" or a 游戏 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 游戏
- **Language / stack**: C
- **Original resource**: https://www.youtube.com/playlist?list=PLkTXsX7igf8edTYU92nU-f5Ntzuf-RKvW
