---
name: misc-tensorflow-gan
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using Python. Use when they mention "build your own misc", "用 Tensorflow 构建一个简单 GAN", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://blog.paperspace.com/implementing-gans-in-tensorflow/
