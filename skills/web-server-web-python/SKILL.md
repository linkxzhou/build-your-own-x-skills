---
name: web-server-web-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Web 服务器 using Python. Use when they mention "build your own web-server", "一个简单的 Web 服务器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: http://aosabook.org/en/500L/a-simple-web-server.html
