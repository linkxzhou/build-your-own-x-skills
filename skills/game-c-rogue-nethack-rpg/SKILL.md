---
name: game-c-rogue-nethack-rpg
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using C. Use when they mention "build your own game", "用 C 编写 Rogue/Nethack RPG", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: C
- **Original resource**: https://www.youtube.com/playlist?list=PLkTXsX7igf8erbWGYT4iSAhpnJLJ0Nk5G
