---
name: regex-engine-regex-deniskyashif-2019-02-17
description: |
  Trigger when the user wants to learn, implement, debug, or extend "实现一个正则表达式引擎" or a 正则表达式引擎 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://deniskyashif.com/2019/02/17/implementing-a-regular-expression-engine/
