---
name: programming-language-compiler-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Ruby. Use when they mention "build your own programming-language", "从零构建编译器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: Ruby
- **Original resource**: https://www.destroyallsoftware.com/screencasts/catalog/a-compiler-from-scratch
