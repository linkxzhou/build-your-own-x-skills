---
name: neural-network-neural-network-javascript-java
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 神经网络 using JavaScript / Java. Use when they mention "build your own neural-network", "神经网络：《代码本色》", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 神经网络
- **Language / stack**: JavaScript / Java
- **Original resource**: https://www.youtube.com/playlist?list=PLRqwX-V7Uu6aCibgK1PTWWu9by6XFdCfh
...
- For long tutorials, load only the relevant reference section for the current milestone.
  This source is marked as video/PDF-like material; first create a structured outline before coding.
...
2. Detect the target language/toolchain. Default to **JavaScript / Java** when the user does not specify another stack.
