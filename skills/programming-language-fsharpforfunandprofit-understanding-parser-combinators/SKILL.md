---
name: programming-language-fsharpforfunandprofit-understanding-parser-combinators
description: |
  Trigger when the user wants to learn, implement, debug, or extend "理解解析器组合子" or a 编程语言 build-your-own project using F#. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 编程语言
- **Language / stack**: F#
- **Original resource**: https://fsharpforfunandprofit.com/posts/understanding-parser-combinators/

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `F#` unless the user chooses another stack.
