---
name: command-line-tool-rust
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Rust. Use when they mention "build your own command-line-tool", "Rust 中的命令行应用", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 命令行工具
- **Language / stack**: Rust
- **Original resource**: https://rust-cli.github.io/book/index.html
