---
name: misc-bernhardwenzel-clojure-spellchecker
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建一个拼写检查器" or a 未分类 build-your-own project using Clojure. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Clojure
- **Original resource**: https://bernhardwenzel.com/articles/clojure-spellchecker/

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `Clojure` unless the user chooses another stack.
