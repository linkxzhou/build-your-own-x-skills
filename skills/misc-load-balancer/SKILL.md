---
name: misc-load-balancer
description: |
  Trigger when the user wants to learn, implement, debug, or extend "让我们创建一个简单负载均衡器" or a 未分类 build-your-own project using Go. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Go
- **Original resource**: https://kasvith.me/posts/lets-create-a-simple-lb-go/
