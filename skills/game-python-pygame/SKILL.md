---
name: game-python-pygame
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Python. Use when they mention "build your own game", "用 Python 与 Pygame 制作游戏", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://inventwithpython.com/makinggames.pdf
