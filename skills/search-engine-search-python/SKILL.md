---
name: search-engine-search-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 搜索引擎 using Python. Use when they mention "build your own search-engine", "用 Python 构建向量空间索引搜索引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://boyter.org/2010/08/build-vector-space-search-engine-python/
