---
name: docker-500-linux
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for Docker using C. Use when they mention "build your own docker", "500 行代码实现 Linux 容器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: Docker
- **Language / stack**: C
- **Original resource**: https://blog.lizzie.io/linux-containers-in-500-loc.html
