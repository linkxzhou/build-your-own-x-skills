---
name: bittorrent-client-bittorrent-nodejs
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for BitTorrent 客户端 using Node.js. Use when they mention "build your own bittorrent-client", "自己写一个 BitTorrent 客户端", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: BitTorrent 客户端
- **Language / stack**: Node.js
- **Original resource**: https://allenkim67.github.io/programming/2016/05/04/how-to-make-your-own-bittorrent-client.html
...
2. Detect the target language/toolchain. Default to **Node.js** when the user does not specify another stack.
