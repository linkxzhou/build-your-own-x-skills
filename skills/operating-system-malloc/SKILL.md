---
name: operating-system-malloc
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 操作系统 using C. Use when they mention "build your own operating-system", "malloc 教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://danluu.com/malloc-tutorial/
