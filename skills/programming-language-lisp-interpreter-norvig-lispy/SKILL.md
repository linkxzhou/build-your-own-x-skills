---
name: programming-language-lisp-interpreter-norvig-lispy
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何用 Python 写 Lisp 解释器" or a 编程语言 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 如何用 Python 写 Lisp 解释器
...
- **Original resource**: http://norvig.com/lispy.html
