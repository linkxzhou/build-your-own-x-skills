---
name: misc-x-window-manager
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C++. Use when they mention "build your own misc", "X Window Manager 如何工作，以及如何编写一个", the source URL, or ask for a Claude Code guided implementation plan.
...
# X Window Manager 如何工作，以及如何编写一个
...
- **Category**: 未分类
- **Language / stack**: C++
- **Original resource**: https://seasonofcode.com/posts/how-x-window-managers-work-and-how-to-write-one-part-i.html
