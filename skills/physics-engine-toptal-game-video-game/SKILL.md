---
name: physics-engine-toptal-game-video-game
description: |
  Trigger when the user wants to learn, implement, debug, or extend "视频游戏物理教程" or a 物理引擎 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 物理引擎
- **Language / stack**: C
- **Original resource**: https://www.toptal.com/game/video-game-physics-part-i-an-introduction-to-rigid-body-dynamics
