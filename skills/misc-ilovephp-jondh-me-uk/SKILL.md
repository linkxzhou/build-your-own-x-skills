---
name: misc-ilovephp-jondh-me-uk
description: |
  Trigger when the user wants to learn, implement, debug, or extend "自己做一个博客" or a 未分类 build-your-own project using PHP. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: PHP
- **Original resource**: https://ilovephp.jondh.me.uk/en/tutorial/make-your-own-blog

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `PHP` unless the user chooses another stack.
