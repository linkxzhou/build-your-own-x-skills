---
name: operating-system-operating-system-lduck11007-operating-systems-development
description: |
  Trigger when the user wants to learn, implement, debug, or extend "给小白的操作系统开发" or a 操作系统 build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 操作系统
- **Language / stack**: C
- **Original resource**: https://medium.com/@lduck11007/operating-systems-development-for-dummies-3d4d786e8ac
