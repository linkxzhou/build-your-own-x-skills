---
name: blockchain-cryptocurrency-blockchain-crystal
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Crystal. Use when they mention "build your own blockchain-cryptocurrency", "用 Crystal 实现你自己的区块链与 PoW 算法", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 区块链 / 加密货币
- **Language / stack**: Crystal
- **Original resource**: https://medium.com/@bradford_hamilton/write-your-own-blockchain-and-pow-algorithm-using-crystal-d53d5d9d0c52
...
2. Detect the target language/toolchain. Default to **Crystal** when the user does not specify another stack.
