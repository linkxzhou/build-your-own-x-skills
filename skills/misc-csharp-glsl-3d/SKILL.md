---
name: misc-csharp-glsl-3d
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 未分类 using C#. Use when they mention "build your own misc", "在 C# 与 GLSL 中从零加载并渲染 3D 骨骼动画", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 未分类
- **Language / stack**: C#
- **Original resource**: https://www.seanjoflynn.com/research/skeletal-animation.html
