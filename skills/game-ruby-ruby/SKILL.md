...
name: game-ruby-ruby
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Ruby. Use when they mention "build your own game", "Ruby 贪吃蛇", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Ruby
- **Original resource**: https://www.diatomenterprises.com/gamedev-on-ruby-why-not/
