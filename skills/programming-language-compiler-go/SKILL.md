---
name: programming-language-compiler-go
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using Go. Use when they mention "build your own programming-language", "超小编译器（The Super Tiny Compiler）", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: Go
- **Original resource**: https://github.com/hazbo/the-super-tiny-compiler
