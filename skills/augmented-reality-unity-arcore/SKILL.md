---
name: augmented-reality-unity-arcore
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 增强现实（AR） using C#. Use when they mention "build your own augmented-reality", "Unity ARCore 教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 增强现实（AR）
- **Language / stack**: C#
- **Original resource**: https://www.youtube.com/playlist?list=PLKIKuXdn4ZMjuUAtdQfK1vwTZPQn_rgSv
