...
name: misc-youtube
description: |
  Trigger when the user wants to learn, implement, debug, or extend "自己做一个游戏引擎" or a 未分类 build-your-own project using C++. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: C++
- **Original resource**: https://www.youtube.com/playlist?list=PLlrATfBNZ98dC-V-N3m0Go4deliWHPFwT
