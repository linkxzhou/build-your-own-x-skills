---
name: 3d-renderer-ray-tracing-cpp
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 3D 渲染器 using C++. Use when they mention "build your own 3d-renderer", "周末搞定光线追踪（Ray Tracing in One Weekend）", the source URL, or ask for a Claude Code guided implementation plan.
...
# 周末搞定光线追踪（Ray Tracing in One Weekend）
...
- **Category**: 3D 渲染器
- **Language / stack**: C++
- **Original resource**: https://raytracing.github.io/books/RayTracingInOneWeekend.html
