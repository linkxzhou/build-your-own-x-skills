---
name: bot-twitter-bot
description: |
  Trigger when the user wants to learn, implement, debug, or extend "使用 Tweepy 用 Python 创建 Twitter 机器人" or a 机器人（Bot） build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 使用 Tweepy 用 Python 创建 Twitter 机器人
...
- **Original resource**: https://medium.freecodecamp.org/creating-a-twitter-bot-in-python-with-tweepy-ac524157a607
