---
name: misc-aosabook-en-500l-same
description: |
  Trigger when the user wants to learn, implement, debug, or extend "同源策略" or a 未分类 build-your-own project using Alloy. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Alloy
- **Original resource**: http://aosabook.org/en/500L/the-same-origin-policy.html

## Workflow

1. Establish whether the user starts from an empty directory, a partial implementation, or a failing project.
2. Default to `Alloy` unless the user chooses another stack.
