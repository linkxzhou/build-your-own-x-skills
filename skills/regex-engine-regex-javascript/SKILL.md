---
name: regex-engine-regex-javascript
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using JavaScript. Use when they mention "build your own regex-engine", "用不到 40 行代码构建正则引擎", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://nickdrane.com/build-your-own-regex/
