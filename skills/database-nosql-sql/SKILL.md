---
name: database-nosql-sql
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 数据库 using Crystal. Use when they mention "build your own database", "为什么你应该构建自己的 NoSQL 数据库", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://medium.com/@marceloboeira/why-you-should-build-your-own-nosql-database-9bbba42039f5
