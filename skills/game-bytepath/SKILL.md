...
name: game-bytepath
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 游戏 using Lua. Use when they mention "build your own game", "BYTEPATH", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 游戏
- **Language / stack**: Lua
- **Original resource**: https://github.com/SSYGEN/blog/issues/30
