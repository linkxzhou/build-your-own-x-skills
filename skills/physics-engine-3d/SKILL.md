...
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 物理引擎 using C++. Use when they mention "build your own physics-engine", "3D 物理引擎教程", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 物理引擎
- **Language / stack**: C++
- **Original resource**: https://www.youtube.com/playlist?list=PLEETnX-uPtBXm1KEr_2zQ6K_0hoGH6JJ0
