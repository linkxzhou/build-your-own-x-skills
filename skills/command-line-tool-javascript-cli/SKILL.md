---
name: command-line-tool-javascript-cli
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 命令行工具 using Node.js. Use when they mention "build your own command-line-tool", "用 JavaScript 创建一个 CLI 工具", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://citw.dev/tutorial/create-your-own-cli-tool
