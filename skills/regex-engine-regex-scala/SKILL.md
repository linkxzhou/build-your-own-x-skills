---
name: regex-engine-regex-scala
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 正则表达式引擎 using Scala. Use when they mention "build your own regex-engine", "没有魔法：正则表达式", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://rcoh.svbtle.com/no-magic-regular-expressions
