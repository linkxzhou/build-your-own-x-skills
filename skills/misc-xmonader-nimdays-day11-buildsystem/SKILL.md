---
name: misc-xmonader-nimdays-day11-buildsystem
description: |
  Trigger when the user wants to learn, implement, debug, or extend "编写构建系统" or a 未分类 build-your-own project using Nim. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: 未分类
- **Language / stack**: Nim
- **Original resource**: https://xmonader.github.io/nimdays/day11_buildsystem.html
