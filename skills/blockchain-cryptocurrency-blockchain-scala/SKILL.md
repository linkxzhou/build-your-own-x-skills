---
name: blockchain-cryptocurrency-blockchain-scala
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 区块链 / 加密货币 using Scala. Use when they mention "build your own blockchain-cryptocurrency", "如何构建一个基于 actor 的简单区块链", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://medium.freecodecamp.org/how-to-build-a-simple-actor-based-blockchain-aac1e996c177
...
2. Detect the target language/toolchain. Default to **Scala** when the user does not specify another stack.
