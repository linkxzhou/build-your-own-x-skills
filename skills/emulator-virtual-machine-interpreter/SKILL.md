---
name: emulator-virtual-machine-interpreter
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 模拟器 / 虚拟机 using C. Use when they mention "build your own emulator-virtual-machine", "自制字节码解释器", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 模拟器 / 虚拟机
- **Language / stack**: C
- **Original resource**: https://medium.com/bumble-tech/home-grown-bytecode-interpreters-51e12d59b25c
