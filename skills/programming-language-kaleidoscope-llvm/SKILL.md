---
name: programming-language-kaleidoscope-llvm
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 编程语言 using C++. Use when they mention "build your own programming-language", "Kaleidoscope：用 LLVM 实现一门语言", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Category**: 编程语言
- **Language / stack**: C++
- **Original resource**: https://llvm.org/docs/tutorial/MyFirstLanguageFrontend/index.html
