---
name: shell-shell-tokenrove-shell
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建你自己的 Shell" or a Shell build-your-own project using C. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Category**: Shell
- **Language / stack**: C
- **Original resource**: https://github.com/tokenrove/build-your-own-shell
