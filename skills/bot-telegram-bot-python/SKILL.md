---
name: bot-telegram-bot-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend "如何用 Python 创建 Telegram 机器人" or a 机器人（Bot） build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 如何用 Python 创建 Telegram 机器人
...
- **Original resource**: https://www.freecodecamp.org/news/how-to-create-a-telegram-bot-using-python/
