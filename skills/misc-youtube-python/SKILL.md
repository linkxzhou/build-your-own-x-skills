---
name: misc-youtube-python
description: |
  Trigger when the user wants to learn, implement, debug, or extend "构建深度学习库" or a 未分类 build-your-own project using Python. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---
...
- **Original resource**: https://www.youtube.com/watch?v=o64FV-ez6Gw
