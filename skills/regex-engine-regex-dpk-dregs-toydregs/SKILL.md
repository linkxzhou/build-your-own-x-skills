---
name: regex-engine-regex-dpk-dregs-toydregs
description: |
  Trigger when the user wants to learn, implement, debug, or extend "用函数式 JavaScript 通过导数法实现正则" or a 正则表达式引擎 build-your-own project using JavaScript. Use this skill for staged Claude Code guidance, milestone planning, minimal implementation, and troubleshooting.
---

# 用函数式 JavaScript 通过导数法实现正则
...
- **Original resource**: http://dpk.io/dregs/toydregs
