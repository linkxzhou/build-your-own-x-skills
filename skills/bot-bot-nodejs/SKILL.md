...
name: bot-bot-nodejs
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 机器人（Bot） using Node.js. Use when they mention "build your own bot", "用 Node.js 与 API.ai 创建一个简单的 Facebook Messenger AI 机器人", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://tutorials.botsfloor.com/creating-a-simple-facebook-messenger-ai-bot-with-api-ai-in-node-js-50ae2fa5c80d
