---
name: search-engine-tf-idf
description: |
  Trigger when the user wants to learn, implement, debug, or extend a build-your-own project for 搜索引擎 using Python. Use when they mention "build your own search-engine", "使用 TF-IDF 从文本中找出重要词", the source URL, or ask for a Claude Code guided implementation plan.
...
- **Original resource**: https://stevenloria.com/tf-idf/
