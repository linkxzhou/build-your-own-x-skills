...
> Example for skill: `game-nes`

## 场景

你想通过 Claude Code 学习并逐步实现 **用 C 编写 NES 游戏**，而不是一次性拿到完整答案。

## 推荐 Prompt

```text
[使用Skills: game-nes]
我想用 C 从零实现「用 C 编写 NES 游戏」。
...
- 技术栈：`C`
- 链接：https://nesdoug.com/

## 适合测试的变体 Prompt

```text
[使用Skills: game-nes]
我已经按照「用 C 编写 NES 游戏」做到一半，但测试失败了。请先阅读项目文件，定位当前处于哪个里程碑，再做最小修复并解释原因。
```

```text
[使用Skills: game-nes]
请基于这个教程资源：https://nesdoug.com/
