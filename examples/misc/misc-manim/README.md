...
> Example for skill: `misc-manim`

## 场景

你想通过 Claude Code 学习并逐步实现 **生成 manim 视频**，而不是一次性拿到完整答案。

## 推荐 Prompt

```text
[使用Skills: misc-manim]
我想用 General 从零实现「生成 manim 视频」。
...
```text
[使用Skills: misc-manim]
我已经按照「生成 manim 视频」做到一半，但测试失败了。请先阅读项目文件，定位当前处于哪个里程碑，再做最小修复并解释原因。
```

```text
[使用Skills: misc-manim]
请基于这个教程资源：https://github.com/ManimCommunity/Manim
