...
| [`web-server-javascript-web`](./web-server-javascript-web/) | Node.js | 用 JavaScript 从零构建你自己的 Web 服务器 |
| [`web-server-lets-build-express`](./web-server-lets-build-express/) | Node.js | lets-build-express |
| [`web-server-nodejs-streams-web`](./web-server-nodejs-streams-web/) | Node.js | 用 NodeJS Streams 从零写 Web 服务器 |
| [`web-server-php-web`](./web-server-php-web/) | PHP | 用纯 PHP 编写 Web 服务器 |
