...
- Available generated skills kept: `263`
- Generated examples: `263`
- Categories: `26`
...
| Category | Examples |
|---|---:|
| [3d-renderer](./examples/3d-renderer/) | 8 |
| [augmented-reality](./examples/augmented-reality/) | 6 |
| [bittorrent-client](./examples/bittorrent-client/) | 5 |
| [blockchain-cryptocurrency](./examples/blockchain-cryptocurrency/) | 14 |
| [bot](./examples/bot/) | 6 |
| [command-line-tool](./examples/command-line-tool/) | 9 |
| [database](./examples/database/) | 10 |
| [docker](./examples/docker/) | 6 |
| [emulator-virtual-machine](./examples/emulator-virtual-machine/) | 12 |
| [frontend-framework-library](./examples/frontend-framework-library/) | 9 |
| [game](./examples/game/) | 32 |
| [git](./examples/git/) | 4 |
| [misc](./examples/misc/) | 45 |
| [network-stack](./examples/network-stack/) | 4 |
| [neural-network](./examples/neural-network/) | 9 |
| [operating-system](./examples/operating-system/) | 10 |
| [physics-engine](./examples/physics-engine/) | 3 |
| [programming-language](./examples/programming-language/) | 34 |
| [regex-engine](./examples/regex-engine/) | 7 |
| [search-engine](./examples/search-engine/) | 4 |
| [shell](./examples/shell/) | 4 |
| [template-engine](./examples/template-engine/) | 4 |
| [text-editor](./examples/text-editor/) | 5 |
| [visual-recognition-system](./examples/visual-recognition-system/) | 2 |
| [web-browser](./examples/web-browser/) | 2 |
| [web-server](./examples/web-server/) | 9 |
...
![Progress](https://img.shields.io/badge/Progress-75%25-yellow?style=flat-square)
