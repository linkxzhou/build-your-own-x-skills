...
- [X] [**C#**: _入门教程：使用 Vuforia 与 Unity 3D 的增强现实应用_](https://www.youtube.com/watch?v=uXNjNcqW4kY) [video]
- [X] [**C#**: _Unity ARCore 教程_](https://www.youtube.com/playlist?list=PLKIKuXdn4ZMjuUAtdQfK1vwTZPQn_rgSv) [video]
- [X] [**C#**: _Unity AR 传送门（Portal）教程_](https://www.youtube.com/playlist?list=PLPCqNOwwN794Gz5fzUSi1p4OqLU0HTmvn) [video]
- [X] [**C#**: _如何在 Unity ARCore 中创建一条 AR 龙_](https://www.youtube.com/watch?v=qTSDPkPyPqs) [video]
- [X] [**C#**: _AR 教程：ARKit 传送门通往“颠倒世界”_](https://www.youtube.com/watch?v=Z5AmqMuNi08) [video]
- [X] [**Python**: _用 Python 与 OpenCV 实现增强现实_](https://bitesofcode.wordpress.com/2017/09/12/augmented-reality-with-python-and-opencv-part-1/)

#### 构建你自己的 `BitTorrent 客户端`

- [X] [**C#**: _用 C# 从零构建 BitTorrent 客户端_](https://www.seanjoflynn.com/research/bittorrent.html)
- [X] [**Go**: _用 Go 从底层开始构建 BitTorrent 客户端_](https://blog.jse.li/posts/torrent/)
- [X] [**Nim**: _编写一个 Bencode 解析器_](https://xmonader.github.io/nimdays/day02_bencode.html)
- [X] [**Node.js**: _自己写一个 BitTorrent 客户端_](https://allenkim67.github.io/programming/2016/05/04/how-to-make-your-own-bittorrent-client.html)
- [X] [**Python**: _Python 3.5 的 BitTorrent 客户端_](http://markuseliasson.se/article/bittorrent-in-python/)

#### 构建你自己的 `区块链 / 加密货币`

- [X] [**ATS**: _函数式区块链_](https://beta.observablehq.com/@galletti94/functional-blockchain)
...
- [X] [**TypeScript**: _NaivecoinStake：基于 PoS 共识构建加密货币的教程_](https://naivecoinstake.learn.uno/)
- [X] [**Rust**: _用 Rust 与 Substrate 构建区块链（分步指南）_](https://hackernoon.com/building-a-blockchain-in-rust-and-substrate-a-step-by-step-guide-for-developers-kc223ybp)
...
- [X] [**Go**: _用 Go 可视化本地 Git 贡献_](https://flaviocopes.com/go-git-contributions/)
- [X] [**Go**: _用 Go 构建命令行应用：lolcat_](https://flaviocopes.com/go-tutorial-lolcat/)
- [X] [**Go**: _用 Go 构建 CLI 命令：cowsay_](https://flaviocopes.com/go-tutorial-cowsay/)
- [X] [**Go**: _Go CLI 教程：fortune 克隆_](https://flaviocopes.com/go-tutorial-fortune/)
- [X] [**Nim**: _编写 stow 的替代方案来管理 dotfiles_](https://xmonader.github.io/nimdays/day06_nistow.html)
- [X] [**Node.js**: _用 JavaScript 创建一个 CLI 工具_](https://citw.dev/tutorial/create-your-own-cli-tool)
- [X] [**Rust**: _Rust 中的命令行应用_](https://rust-cli.github.io/book/index.html)
- [X] [**Rust**: _用 Rust 编写命令行工具_](https://mattgathu.dev/2017/08/29/writing-cli-app-rust.html)
- [X] [**Zig**: _从零用 Zig 构建你的 CLI 应用_](https://rebuild-x.github.io/docs/#/./zig/terminal/cli)
...
- [X] [**Go**: _从零构建你自己的 Redis_](https://www.build-redis-from-scratch.dev/)
- [X] [**JavaScript**: _Dagoba：内存图数据库_](http://aosabook.org/en/500L/dagoba-an-in-memory-graph-database.html)
- [X] [**Python**: _DBDB：狗窝数据库_](http://aosabook.org/en/500L/dbdb-dog-bed-database.html)
- [X] [**Python**: _用 Python 写一个迷你 Redis_](http://charlesleifer.com/blog/building-a-simple-redis-server-with-python/)
- [X] [**Ruby**: _用 Ruby 构建快速、持久化的 KV 存储_](https://dineshgowda.com/posts/build-your-own-persistent-kv-store/)
- [X] [**Rust**: _构建你自己的 Redis 客户端与服务端_](https://tokio.rs/tokio/tutorial/setup)

#### 构建你自己的 `Docker`

- [X] [**C**: _500 行代码实现 Linux 容器_](https://blog.lizzie.io/linux-containers-in-500-loc.html)
- [X] [**Go**: _用不到 100 行 Go 构建自己的容器_](https://www.infoq.com/articles/build-a-container-golang)
- [X] [**Go**: _用 Go 从零构建容器_](https://www.youtube.com/watch?v=8fi7uSYlOdc) [video]
- [X] [**Python**: _Linux 容器工作坊：从零重建 Docker_](https://github.com/Fewbytes/rubber-docker)
- [X] [**Python**: _一个 Docker 的概念验证替代品（100% Python）_](https://github.com/tonybaloney/mocker)
- [X] [**Shell**: _用大约 100 行 bash 实现 Docker_](https://github.com/p8952/bocker)
...
- [X] [**C++**: _模拟器教程（GameBoy 模拟器）_](http://www.codeslinger.co.uk/pages/projects/gameboy.html)
- [X] [**C++**: _模拟器教程（Master System 模拟器）_](http://www.codeslinger.co.uk/pages/projects/mastersystem/memory.html)
- [X] [**C++**: _从零构建 NES 模拟器_](https://www.youtube.com/playlist?list=PLrOv9FMX8xJHqMvSGB_9G9nZZ_4IgteYf) [video]
- [X] [**Common Lisp**: _用 Common Lisp 实现 CHIP-8_](http://stevelosh.com/blog/2016/12/chip8-cpu/)
- [X] [**JavaScript**: _用 JavaScript 做 GameBoy 模拟_](http://imrannazar.com/GameBoy-Emulation-in-JavaScript)
- [X] [**Python**: _模拟器基础：编写你自己的 Chip-8 模拟器/解释器_](http://omokute.blogspot.com.br/2012/06/emulation-basics-write-your-own-chip-8.html)
- [X] [**Rust**: _0dmg：通过构建部分 Game Boy 模拟器学习 Rust_](https://jeremybanks.github.io/0dmg/)
...
- [X] [**C**: _用 C 编写 NES 游戏_](https://nesdoug.com/)
...
- [X] [**C++**: _用 C++ 重制 Cavestory_](https://www.youtube.com/watch?v=ETvApbD5xRo&list=PLNOBk_id22bw6LXhrGfhVwqQIa-M2MsLa) [video]
- [X] [**C++**: _重构 Cave Story_](https://www.youtube.com/playlist?list=PL006xsVEsbKjSKBmLu1clo85yLrwjY67X) [video]
- [X] [**C++**: _从零做 Space Invaders_](http://nicktasios.nl/posts/space-invaders-from-scratch-part-1.html)
- [X] [**C#**: _通过构建一个简单 RPG 学习 C#_](http://scottlilly.com/learn-c-by-building-a-simple-rpg-index/)
- [X] [**C#**: _用 C# 创建 Roguelike 游戏_](https://roguesharp.wordpress.com/)
- [X] [**C#**: _构建一个 C#/WPF RPG_](https://scottlilly.com/build-a-cwpf-rpg/)
- [X] [**Go**: _用 Go 做游戏_](https://www.youtube.com/playlist?list=PLDZujg-VgQlZUy1iCqBbe5faZLMkA3g2x) [video]
- [X] [**Java**: _用 Java 写 2D 游戏引擎（完整入门课）_](https://www.youtube.com/watch?v=025QFeZfeyM) [video]
- [X] [**Java**: _LWJGL 3 的 3D 游戏开发_](https://lwjglgamedev.gitbooks.io/3d-game-development-with-lwjgl/content/)
- [X] [**JavaScript**: _用 Phaser 制作 2D 打砖块_](https://developer.mozilla.org/en-US/docs/Games/Tutorials/2D_breakout_game_Phaser)
- [X] [**JavaScript**: _用 Phaser 在 HTML5 中做 Flappy Bird_](http://www.lessmilk.com/tutorial/flappy-bird-phaser-1)
- [X] [**JavaScript**: _用 React、Redux 与 SVG 开发游戏_](https://auth0.com/blog/developing-games-with-react-redux-and-svg-part-1/)
- [X] [**JavaScript**: _从零构建你自己的 8 号球台球游戏_](https://www.youtube.com/watch?v=aXwCrtAo4Wc) [video]
- [X] [**JavaScript**: _如何制作你的第一个 Roguelike_](https://gamedevelopment.tutsplus.com/tutorials/how-to-make-your-first-roguelike--gamedev-13677)
- [X] [**JavaScript**: _像程序员一样思考：只用 JS/HTML/CSS 做贪吃蛇_](https://medium.freecodecamp.org/think-like-a-programmer-how-to-build-snake-using-only-javascript-html-and-css-7b1479c3339e)
- [X] [**Lua**: _BYTEPATH_](https://github.com/SSYGEN/blog/issues/30)
- [X] [**Python**: _用 PyGame 开发游戏_](https://pythonprogramming.net/pygame-python-3-part-1-intro/)
- [X] [**Python**: _用 Python 与 Pygame 制作游戏_](https://inventwithpython.com/makinggames.pdf) [pdf]
- [X] [**Python**: _Roguelike 教程（修订版）_](http://rogueliketutorials.com/)
- [X] [**Ruby**: _用 Ruby 开发游戏_](https://leanpub.com/developing-games-with-ruby/read)
- [X] [**Ruby**: _Ruby 贪吃蛇_](https://www.diatomenterprises.com/gamedev-on-ruby-why-not/)
- [X] [**Rust**: _Rust 冒险：一个基础 2D 游戏_](https://a5huynh.github.io/posts/2018/adventures-in-rust/)
- [X] [**Rust**: _Rust + tcod 的 Roguelike 教程_](https://tomassedovic.github.io/roguelike-tutorial/)
...
- [X] [**C**: _Beej 的网络编程指南_](http://beej.us/guide/bgnet/)
- [X] [**C**: _让我们写一个 TCP/IP 协议栈_](http://www.saminiir.com/lets-code-tcp-ip-stack-1-ethernet-arp/)
- [X] [**C / Python**: _构建你自己的 VPN/虚拟交换机_](https://github.com/peiyuanix/build-your-own-zerotier)
- [X] [**Ruby**: _如何用 Ruby 构建网络协议栈_](https://medium.com/geckoboard-under-the-hood/how-to-build-a-network-stack-in-ruby-f73aeb1b661b)

#### 构建你自己的 `神经网络`

- [X] [**C#**: _神经网络 OCR_](https://www.codeproject.com/Articles/11285/Neural-Network-OCR)
...
- [X] [**Haskell**: _让我们构建一个编译器_](https://g-ford.github.io/cradle/)
- [X] [**Haskell**: _Write You a Haskell_](http://dev.stephendiehl.com/fun/)
- [X] [**Haskell**: _48 小时写一个 Scheme_](https://en.wikibooks.org/wiki/Write_Yourself_a_Scheme_in_48_Hours)
- [X] [**Haskell**: _Write You A Scheme_](https://www.wespiser.com/writings/wyas/home.html)
- [X] [**Java**: _《Crafting Interpreters》：制作编程语言的手册_](http://www.craftinginterpreters.com/)
- [X] [**Java**: _创建 JVM 语言_](http://jakubdziworski.github.io/categories.html#Enkel-ref)
- [X] [**JavaScript**: _超小编译器（The Super Tiny Compiler）_](https://github.com/jamiebuilds/the-super-tiny-compiler)
- [X] [**JavaScript**: _超小解释器（The Super Tiny Interpreter）_](https://github.com/keyanzhang/the-super-tiny-interpreter)
- [X] [**JavaScript**: _小型 Lisp 解释器_](https://maryrosecook.com/blog/post/little-lisp-interpreter)
- [X] [**JavaScript**: _如何用 JavaScript 实现一门编程语言_](http://lisperator.net/pltut/)
- [X] [**JavaScript**: _让我们写一个 Lisp_](https://idiocy.org/lets-go-write-a-lisp/part-1.html)
- [X] [**OCaml**: _编写一个 C 编译器_](https://norasandler.com/2017/11/29/Write-a-Compiler.html)
- [X] [**OCaml**: _写 Lisp 系列_](https://bernsteinbear.com/blog/lisp/)
...
- [X] [**C**: _正则表达式匹配器_](https://www.cs.princeton.edu/courses/archive/spr09/cos333/beautiful.html)
...
- [X] [**Python**: _用 Python 机器学习开发车牌识别系统_](https://medium.com/devcenter/developing-a-license-plate-recognition-system-with-machine-learning-in-python-787833569ccd)
- [X] [**Python**: _用 Tensorflow 深度学习构建人脸识别流水线_](https://hackernoon.com/building-a-facial-recognition-pipeline-with-deep-learning-in-tensorflow-66e7645015b8)
...
- [X] [**Rust**: _让我们构建一个浏览器引擎_](https://limpet.net/mbrubeck/2014/08/08/toy-layout-engine-1.html)
- [X] [**Python**: _Browser Engineering_](https://browser.engineering)

#### 构建你自己的 `Web 服务器`

- [X] [**C#**: _从零编写 Web 服务器_](https://www.codeproject.com/Articles/859108/Writing-a-Web-Server-from-Scratch)
- [X] [**Node.js**: _用 JavaScript 从零构建你自己的 Web 服务器_](https://build-your-own.org/webserver/)
- [X] [**Node.js**: _用 NodeJS Streams 从零写 Web 服务器_](https://www.codementor.io/@ziad-saab/let-s-code-a-web-server-from-scratch-with-nodejs-streams-h4uc9utji)
...
- [X] [**JavaScript**: _从零实现 Promise（TDD 风格）_](https://www.mauriciopoppe.com/notes/computer-science/computation/promises/)
- [X] [**JavaScript**: _自己实现 JavaScript 的 call() / apply() / bind()_](https://blog.usejournal.com/implement-your-own-call-apply-and-bind-method-in-javascript-42cc85dba1b)
